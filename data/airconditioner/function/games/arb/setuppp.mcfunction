...
execute if score randomizer AC_silly matches 3 run tellraw @a [{"text":"[silly] ","bold":true,"color":"light_purple"},{"text":"Strzały strzelają z każdej strony","color":"white","bold":false}]
execute if score randomizer AC_silly matches 4 run tellraw @a [{"text":"[silly] ","bold":true,"color":"light_purple"},{"text":"Gracze otrzymuja wind charge","color":"white","bold":false}]


# 1
execute if score randomizer AC_silly matches 1 run team modify gracz friendlyFire true
execute if score randomizer AC_silly matches 1 run team modify gracz collisionRule always
