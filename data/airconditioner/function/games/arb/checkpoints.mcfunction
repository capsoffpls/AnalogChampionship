scoreboard players add @a[x=-2004,y=68,z=-954,dx=9,dy=9,tag=InGame,gamemode=adventure,scores={AC_arbCurrentCheckpoint=0}] AC_sillyPointsHeld 10
...
scoreboard players add @a[x=-2010,y=70,z=-901,dx=21,dy=10,tag=InGame,gamemode=adventure,scores={AC_arbCurrentCheckpoint=1}] AC_sillyPointsHeld 10
