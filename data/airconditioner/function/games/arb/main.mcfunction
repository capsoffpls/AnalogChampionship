...
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score second AC_arbArrow matches 9 if score tick AC_arbArrow matches 19 if score randomizer dev_silly matches 3 run execute store result score shootside2 AC_arbRNG run random value 1..2
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score second AC_arbArrow matches 9 if score tick AC_arbArrow matches 19 run execute store result score shootside AC_arbRNG run random value 1..2
