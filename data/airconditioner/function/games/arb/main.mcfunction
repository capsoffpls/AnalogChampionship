...
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 run function airconditioner:games/arb/checkpoints
...
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 1..31 if score tick AC_arbArrow matches 19 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 11..24 if score tick AC_arbArrow matches 9 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 19..24 if score tick AC_arbArrow matches 4 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 19..24 if score tick AC_arbArrow matches 14 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 25..28 if score tick AC_arbArrow matches 15 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 25..28 if score tick AC_arbArrow matches 11 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 25..28 if score tick AC_arbArrow matches 7 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 25..31 if score tick AC_arbArrow matches 3 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 29..31 if score tick AC_arbArrow matches 6 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 29..31 if score tick AC_arbArrow matches 9 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 29..31 if score tick AC_arbArrow matches 13 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 29..31 if score tick AC_arbArrow matches 16 run execute as @a[tag=InGame,gamemode=adventure] at @s run function airconditioner:games/arb/shoot
...
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score second AC_arbArrow matches 9 if score tick AC_arbArrow matches 19 if score randomizer AC_silly matches 3 run execute store result score shootside2 AC_arbRNG run random value 1..2
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score second AC_arbArrow matches 9 if score tick AC_arbArrow matches 19 run execute store result score shootside AC_arbRNG run random value 1..2
...
execute if score arb AC_running matches 1 unless score randomizer AC_silly matches 2 unless score randomizer AC_silly matches 4 run execute if score arb1 AC_functions matches 1 run item replace entity @a[tag=InGame,gamemode=adventure] weapon.mainhand with white_wool[can_place_on={blocks:"#airconditioner:allblocks"}] 64
execute if score arb AC_running matches 1 if score randomizer AC_silly matches 2 run execute run item replace entity @a[gamemode=adventure,tag=InGame] weapon.mainhand with white_wool[can_place_on=[{blocks:"#airconditioner:allblocks"}],can_break=[{blocks:"white_wool"}],attribute_modifiers=[{id:"block_break_speed",type:"block_break_speed",amount:128,operation:"add_value",slot:"hand",display:{type:"hidden"}},{id:"block_interaction_range",type:"block_interaction_range",amount:1,operation:"add_value",slot:"hand"}]] 64
execute if score arb AC_running matches 1 if score randomizer AC_silly matches 4 run execute run item replace entity @a[gamemode=adventure,tag=InGame] weapon.mainhand with wind_charge 64
...
execute if score arb AC_running matches 1 run execute as @a[tag=InGame,gamemode=adventure] if entity @s[x=-2007,y=90,z=-854,dx=14,dy=4] run function airconditioner:games/arb/reward
...
execute if score arb AC_running matches 1 run execute if score arb AC_time matches -1 run function airconditioner:base/endsound
...
execute if score arb AC_running matches 1 run execute if score arb AC_time matches -61 run function airconditioner:auto/invoke
