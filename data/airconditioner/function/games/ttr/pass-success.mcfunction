execute if score @s AC_ttrVelocity matches 0..119 run scoreboard players add @s AC_sillyPointsHeld 5
...
execute if score @s AC_ttrVelocity matches 120..239 run scoreboard players add @s AC_sillyPointsHeld 10
...
execute if score @s AC_ttrVelocity matches 240.. run scoreboard players add @s AC_sillyPointsHeld 20
