...
############### ring
execute as @e[type=marker,tag=ttrMarker] at @s run function airconditioner:games/ttr/ring-loop
execute as @a[gamemode=spectator] run function airconditioner:games/ttr/ring-draw
...
function airconditioner:games/ttr/ride
...
execute if score ttr AC_time matches 0..1800 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/ttr/velocity
...
execute as @a[tag=InGame,gamemode=adventure] if entity @s[x=1983,y=71,z=-1101,dx=34,dy=12,dz=1] run function airconditioner:games/ttr/metamfetamina
...
execute if score ttr AC_time matches -1 run function airconditioner:base/endsound
...
execute if score ttr AC_time matches -1 run function airconditioner:base/remove-spawn-tags
...
execute if score ttr AC_time matches -61 run function airconditioner:auto/invoke
