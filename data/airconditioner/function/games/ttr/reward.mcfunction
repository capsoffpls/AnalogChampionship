scoreboard players operation @s AC_rankedTimeFinished = ttr AC_time
...
tellraw @s [{"text":"[TTR] ","bold":true,"color":"dark_green"},{"text":"+","color":"gold","bold":false},{"score":{"name":"@s","objective":"AC_pointBuffer"},"color":"gold","bold":false},{"text":"≡","color":"gold","bold":false}]
