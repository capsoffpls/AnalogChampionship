...
function airconditioner:games/legacy/ctf/rng/map
execute if score ctf AC_chosenMap matches 0 run function airconditioner:games/legacy/ctf/launch-map/0
execute if score ctf AC_chosenMap matches 1 run function airconditioner:games/legacy/ctf/launch-map/1
...
function airconditioner:base/protip
