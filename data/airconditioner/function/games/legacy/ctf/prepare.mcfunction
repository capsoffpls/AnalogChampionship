...
execute if score IGOverall AC_playercount matches ..1 run scoreboard objectives setdisplay sidebar AC_sillyPoints
...
function airconditioner:games/legacy/ctf/wool-removal