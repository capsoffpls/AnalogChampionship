...
execute if score arb-l AC_running matches 1 run execute if score arb1 AC_functions matches 1 run execute if entity @a[scores={AC_arbDeathCheck=1..}] run scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 5
...
execute if score arb-l AC_running matches 1 run execute if score arb1 AC_functions matches 1 run function airconditioner:arb-legacy/destroy
...
execute if score arb-l AC_running matches 1 run execute if score arb1 AC_functions matches 1 run execute if score InGame AC_playercount matches 1 run scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 15
...
execute if score arb-l AC_running matches 1 run execute if score arb1 AC_functions matches 1 run execute if score InGame AC_playercount matches 1 run function airconditioner:base/endsound
...
execute if score arb-l AC_running matches 1 run execute if score arb1 AC_functions matches 1 run execute if score arb AC_time matches 0 run scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 10
execute if score arb-l AC_running matches 1 run execute if score arb1 AC_functions matches 1 run execute if score arb AC_time matches 0 run function airconditioner:base/endsound
...
execute if score arb-l AC_running matches 1 run execute if score arb2 AC_functions matches 1 run function airconditioner:arb-legacy/switch
...
execute if score arb-l AC_running matches 1 run execute if score arb AC_time matches ..-79 run function airconditioner:auto/invoke
