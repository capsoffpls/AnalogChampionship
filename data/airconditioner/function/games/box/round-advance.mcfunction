...
execute if score round AC_boxCheck matches 1..6 run function airconditioner:games/box/class-give
execute if score round AC_boxCheck matches 1..6 run function airconditioner:games/box/tp-players
