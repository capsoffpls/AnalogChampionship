execute if score box AC_running matches 1 run execute if score box AC_time matches 1880 run function airconditioner:games/box/tp-to-map
execute if score box AC_running matches 1 run execute if score box AC_time matches 1880 run function airconditioner:games/box/class-items
...
execute if score box AC_running matches 1 run execute if score box AC_time matches 1420..1880 run function airconditioner:games/box/class-backend
...
execute if score box AC_running matches 1 run execute if score box AC_time matches 1415 run function airconditioner:games/box/autoassign-class
execute if score box AC_running matches 1 run execute if score box AC_time matches 1415 run gamemode spectator @a
execute if score box AC_running matches 1 run execute if score box AC_time matches 1400 run function airconditioner:games/box/round-advance
execute if score box AC_running matches 1 run execute if score box AC_time matches 1399 run execute if score round AC_boxCheck matches 1..6 run function airconditioner:games/box/spawn-items
...
execute if score box AC_running matches 1 run execute if score box AC_time matches 1200 run function airconditioner:games/box/round-start

execute if score box AC_running matches 1 run execute if score box1 AC_functions matches 1 if score box AC_time matches 1..1200 run function airconditioner:games/box/round-backend
...
execute if score box AC_running matches 1 run execute if score box1 AC_functions matches 1 run execute as @a[scores={AC_deathmessage=1..},gamemode=adventure] if entity @s run scoreboard players add @a[scores={AC_killmessage=1..}] AC_sillyPointsHeld 10
...
execute if score box AC_running matches 1 run execute if score box AC_time matches 0 run function airconditioner:games/box/round-end
...
execute if score box AC_running matches 1 run execute if score box AC_time matches -1000 run function airconditioner:base/endsound
...
execute if score box AC_running matches 1 run execute if score box AC_time matches -1060 run function airconditioner:base/remove-spawn-tags
...
execute if score box AC_running matches 1 run execute if score box AC_time matches -1060 run function airconditioner:auto/invoke
