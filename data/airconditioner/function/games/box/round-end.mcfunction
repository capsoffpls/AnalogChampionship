...
execute unless score win-red AC_boxCheck matches 1.. unless score win-yellow AC_boxCheck matches 1.. unless score win-green AC_boxCheck matches 1.. unless score win-blue AC_boxCheck matches 1.. run function airconditioner:games/box/check-for-draw
...
execute if score win-red AC_boxCheck matches 1.. run scoreboard players add @a[tag=boxRed] AC_sillyPointsHeld 40
...
execute if score win-yellow AC_boxCheck matches 1.. run scoreboard players add @a[tag=boxYellow] AC_sillyPointsHeld 40
...
execute if score win-green AC_boxCheck matches 1.. run scoreboard players add @a[tag=boxGreen] AC_sillyPointsHeld 40
...
execute if score win-blue AC_boxCheck matches 1.. run scoreboard players add @a[tag=boxBlue] AC_sillyPointsHeld 40
