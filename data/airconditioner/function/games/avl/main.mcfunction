...
execute if score avl AC_running matches 1 if score avl1 AC_functions matches 1 run execute if entity @a[gamemode=spectator,scores={AC_avlDeathCheck=1..}] as @a[tag=InGame,gamemode=adventure] run scoreboard players operation @s AC_sillyPointsHeld += @s AC_pointBuffer
...
execute if score avl AC_running matches 1 if score avl1 AC_functions matches 1 run execute if score InGame AC_playercount matches 1 run scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 15
...
execute if score avl AC_running matches 1 if score avl AC_time matches -500 run function airconditioner:base/endsound
...
execute if score avl AC_running matches 1 if score avl AC_time matches -560 run function airconditioner:auto/invoke
