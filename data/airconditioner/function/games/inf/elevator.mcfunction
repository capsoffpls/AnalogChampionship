...
execute if block 1563 52 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 50 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 60 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 58 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 68 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 66 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 76 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 74 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 84 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 82 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 92 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 90 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 100 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 98 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 108 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1563 106 965 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close

execute if block 1560 51 960 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1560 59 960 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1560 67 960 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1560 75 960 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1560 83 960 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1560 91 960 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1560 99 960 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close
execute if block 1560 107 960 polished_blackstone_button[powered=true] run function airconditioner:games/inf/elevator-close

execute if score jedzie AC_infCount matches 1 run function airconditioner:games/inf/elevator-close
