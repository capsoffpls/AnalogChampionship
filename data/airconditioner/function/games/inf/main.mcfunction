...
execute if score inf AC_running matches 1 if score inf1 AC_functions matches 1 run execute as @a[scores={AC_infdeath=1..},team=ac_infInfected] if entity @s run scoreboard players add @a[scores={AC_killmessage=1..}] AC_sillyPointsHeld 10
...
execute if score inf AC_running matches 1 if score inf1 AC_functions matches 1 run execute as @a[scores={AC_infdeath=1..},team=ac_infSurvivor] if entity @s run scoreboard players add @a[scores={AC_killmessage=1..},team=ac_infInfected] AC_sillyPointsHeld 15
...
execute if score inf AC_running matches 1 if score inf1 AC_functions matches 1 run execute if score inf AC_time matches 0 run scoreboard players add @a[team=ac_infSurvivor,tag=InGame,gamemode=adventure] AC_sillyPointsHeld 20
...
execute if score inf AC_running matches 1 if score inf1 AC_functions matches 1 run execute unless entity @a[team=ac_infSurvivor,gamemode=adventure,tag=InGame] run scoreboard players add @a[team=ac_infSurvivor,tag=InGame,gamemode=adventure] AC_sillyPointsHeld 15
...
execute if score inf AC_running matches 1 if score inf3 AC_functions matches 1 run execute if score infected AC_infCount matches 5.. run function airconditioner:games/inf/give-knockback
...
execute if score inf AC_running matches 1 if score inf4 AC_functions matches 1 run function airconditioner:games/inf/elevator
execute if score inf AC_running matches 1 if score inf4 AC_functions matches 1 run execute if score jedzie AC_infCount matches 1 run function airconditioner:games/inf/elevator-drive

execute if score inf AC_running matches 1 if score inf AC_time matches -1 run function airconditioner:base/endsound
...
execute if score inf AC_running matches 1 if score inf AC_time matches -100 run function airconditioner:auto/invoke
