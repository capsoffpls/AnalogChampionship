scoreboard players add @a[team=ac_tfwRed] AC_sillyPointsHeld 30
...
execute if score score AC_tfwCheck matches -20 run scoreboard players add @a[team=ac_tfwRed] AC_sillyPointsHeld 15
