...
execute if score tfw AC_running matches 1 if score tfw1 AC_functions matches 1 run execute if entity @a[team=ac_tfwRed,scores={AC_killmessage=1..}] if entity @a[team=ac_tfwBlue,scores={AC_deathmessage=1..}] run function airconditioner:games/tfw/advance-red
execute if score tfw AC_running matches 1 if score tfw1 AC_functions matches 1 run execute if entity @a[team=ac_tfwRed,scores={AC_deathmessage=1..}] if entity @a[team=ac_tfwBlue,scores={AC_killmessage=1..}] run function airconditioner:games/tfw/advance-blue

execute if score tfw AC_running matches 1 if score tfw1 AC_functions matches 1 if score score AC_tfwCheck matches -20 run function airconditioner:games/tfw/red-win
execute if score tfw AC_running matches 1 if score tfw1 AC_functions matches 1 if score score AC_tfwCheck matches 20 run function airconditioner:games/tfw/blue-win
...
execute if score tfw AC_running matches 1 if score tfw AC_time matches 1 run execute if score score AC_tfwCheck matches 1..19 run function airconditioner:games/tfw/blue-win
execute if score tfw AC_running matches 1 if score tfw AC_time matches 1 run execute if score score AC_tfwCheck matches -19..-1 run function airconditioner:games/tfw/red-win
...
execute if score tfw AC_running matches 1 if score tfw AC_time matches 0 run function airconditioner:base/remove-spawn-tags
execute if score tfw AC_running matches 1 if score tfw AC_time matches 0 run function airconditioner:base/endsound
...
execute if score tfw AC_running matches 1 if score tfw AC_time matches -60 run function airconditioner:auto/invoke
