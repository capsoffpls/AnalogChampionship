execute if score ctf AC_running matches 1 if score ctf AC_time matches 24036 run function airconditioner:games/ctf/prepare
...
execute if score ctf AC_running matches 1 if score ctf AC_time matches 0 run function airconditioner:games/ctf/deathmatch-start
execute if score ctf AC_running matches 1 if score ctf AC_time matches -6000..-2400 run function airconditioner:games/ctf/deathmatch-border
...
execute if score ctf AC_running matches 1 if score ctf AC_time matches -6000 run function airconditioner:games/ctf/end {team:"none"}
...
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function airconditioner:games/ctf/spawnprot
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function airconditioner:games/ctf/special-items
