...
execute as @e[type=marker,tag=ctfItemGen] if score second AC_misc matches 19 if score @s AC_ctfItemGen matches 0 at @s run function airconditioner:games/ctf/spawn-special-item