...
execute if score ctf AC_time matches -2400 at @e[type=marker,tag=border-center] run function airconditioner:games/ctf/deathmatch-destroy with storage ac:ctf.borderdestroy
...
execute if score timer AC_ctfDeathmatch matches 17.. at @e[type=marker,tag=border-center] run function airconditioner:games/ctf/deathmatch-destroy with storage ac:ctf.borderdestroy
