...
execute if score south1 AC_ctfFlagStatus matches 1 run scoreboard players add @a[team=ac_ctfNorth] AC_sillyPointsHeld 30
...
execute if score south1 AC_ctfFlagStatus matches 1 run scoreboard players add @s AC_sillyPointsHeld 15
