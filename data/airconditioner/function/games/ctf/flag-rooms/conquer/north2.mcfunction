...
execute if score north2 AC_ctfFlagStatus matches 1 run scoreboard players add @a[team=ac_ctfSouth] AC_sillyPointsHeld 30
...
execute if score north2 AC_ctfFlagStatus matches 1 run scoreboard players add @s AC_sillyPointsHeld 15
