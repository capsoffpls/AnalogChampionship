...
execute if score asp AC_running matches 1 if score asp1 AC_functions matches 1 if score randomizer AC_silly matches 4 run effect give @a[gamemode=adventure,tag=InGame] blindness 10 10 true

execute positioned -500 60 -2000 run kill @e[type=item,distance=..96]
##########################################################################################################################################
...
execute if score asp AC_running matches 1 if score asp1 AC_functions matches 1 run execute as @a[gamemode=adventure,scores={AC_aspDeath=1..}] if entity @s run function airconditioner:games/asp/death
...
execute if score asp AC_running matches 1 if score asp AC_time matches ..0 run execute if score InGame AC_playercount matches 1 run function airconditioner:games/asp/end-winner
execute if score asp AC_running matches 1 if score asp AC_time matches ..0 run execute if score InGame AC_playercount matches 0 run function airconditioner:games/asp/end-nowinner
...
execute if score asp AC_running matches 1 if score asp AC_time matches 1060 run function airconditioner:base/endsound
