execute if score hrc AC_running matches 1 if score hrc AC_time matches 6200 run function airconditioner:games/hrc/prepare
...
execute if score hrc AC_running matches 1 if score hrc1 AC_functions matches 1 run function airconditioner:games/hrc/ride
...
execute if score hrc AC_running matches 1 if score hrc1 AC_functions matches 1 run function airconditioner:games/hrc/bonus
execute if score hrc AC_running matches 1 if score hrc1 AC_functions matches 1 run function airconditioner:games/hrc/velocity-decay
...
execute if score hrc AC_running matches 1 if score hrc1 AC_functions matches 1 run function airconditioner:games/hrc/calc-diff
...
execute if score hrc AC_running matches 1 if score hrc AC_time matches 1..6000 run function airconditioner:games/hrc/checkpoints
...
execute if score hrc AC_running matches 1 if score hrc AC_time matches -1 run function airconditioner:base/remove-spawn-tags
...
execute if score hrc AC_running matches 1 if score hrc AC_time matches -1 run function airconditioner:base/endsound
...
execute if score hrc AC_running matches 1 if score hrc AC_time matches -61 run function airconditioner:auto/invoke
