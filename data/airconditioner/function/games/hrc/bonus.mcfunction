...
execute as @e[type=item_display,tag=bonus,tag=!collected] at @s run execute as @e[type=horse,dy=1,limit=1] on passengers if score hrc AC_chosenMap matches 1 if score @s AC_hrcVelocity matches 450 run function airconditioner:games/hrc/bonus-activate
execute as @e[type=item_display,tag=bonus,tag=!collected] at @s run execute as @e[type=horse,dy=1,limit=1] on passengers if score hrc AC_chosenMap matches 2 if score @s AC_hrcVelocity matches 400 run function airconditioner:games/hrc/bonus-activate
