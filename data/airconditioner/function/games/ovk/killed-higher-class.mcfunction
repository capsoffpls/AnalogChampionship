...
execute if score diff AC_ovkScores matches 1 run scoreboard players add @s AC_sillyPointsHeld 5
...
execute if score diff AC_ovkScores matches 2 run scoreboard players add @s AC_sillyPointsHeld 15
...
execute if score diff AC_ovkScores matches 3 run scoreboard players add @s AC_sillyPointsHeld 35
...
execute if score diff AC_ovkScores matches 4 run scoreboard players add @s AC_sillyPointsHeld 60
