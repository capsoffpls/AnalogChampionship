scoreboard players add @a[x=-1504,y=50,z=1037,dx=8,dy=5,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=0}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1504,y=50,z=1054,dx=8,dy=5,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=1}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1504,y=50,z=1063,dx=8,dy=5,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=2}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1504,y=50,z=1079,dx=8,dy=5,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=3}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1511,y=50,z=1117,dz=2,dy=2,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=4}] AC_sillyPointsHeld 10
...
execute as @a[x=-1511,y=50,z=1117,dz=2,dy=2,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=4}] if score @s AC_overtimePersonal matches 1.. run function airconditioner:base/overtime-personal-end
...
scoreboard players add @a[x=-1542,y=39,z=1110,dx=12,dy=8,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=5}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1542,y=39,z=1093,dx=12,dy=8,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=6}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1542,y=39,z=1077,dx=12,dy=8,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=7}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1542,y=39,z=1054,dx=12,dy=8,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=8}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1542,y=39,z=1021,dx=12,dy=8,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=9}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1562,y=46,z=999,dx=1,dy=1,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=10}] AC_sillyPointsHeld 10
...
execute as @a[x=-1562,y=46,z=999,dx=1,dy=1,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=10}] if score @s AC_overtimePersonal matches 1.. run function airconditioner:base/overtime-personal-end
...
scoreboard players add @a[x=-1547,y=43,z=975,dz=10,dy=10,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=11}] AC_sillyPointsHeld 5
...
scoreboard players add @a[x=-1531,y=43,z=975,dz=10,dy=10,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=12}] AC_sillyPointsHeld 5
...
execute as @a[x=-1510,y=50,z=1005,dy=1,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=13}] run function airconditioner:games/dtr/reward
...
execute as @a[x=-1510,y=50,z=1005,dy=1,tag=InGame,gamemode=adventure,scores={AC_dtrCurrentCheckpoint=13}] if score @s AC_overtimePersonal matches 1.. run function airconditioner:base/overtime-personal-end
