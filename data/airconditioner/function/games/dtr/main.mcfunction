...
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run function airconditioner:games/dtr/traps
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run function airconditioner:games/dtr/area-main
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run function airconditioner:games/dtr/teleporters
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run function airconditioner:games/dtr/checkpoints
...
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run execute as @a[team=ac_dtrRunner,scores={AC_killmessage=1..}] if entity @a[team=ac_dtrDeath,scores={AC_deathmessage=1..}] run function airconditioner:games/dtr/death-inherit
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run execute as @a[team=ac_dtrRunner,scores={AC_deathmessage=1..}] if entity @s run function airconditioner:games/dtr/death-credit
...
execute if score dtr AC_running matches 1 if score dtr AC_time matches 0 run function airconditioner:base/endsound
execute if score dtr AC_running matches 1 if score dtr AC_time matches 0 run function airconditioner:base/remove-spawn-tags
...
execute if score dtr AC_running matches 1 if score dtr AC_time matches -100 run function airconditioner:auto/invoke
