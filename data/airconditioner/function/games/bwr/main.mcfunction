...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 8400 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 7200 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 6000 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 4800 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 3600 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 2400 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 1200 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr1 AC_functions matches 1 run execute as @a[scores={AC_deathmessage=1..}] if entity @s run scoreboard players add @a[tag=InGame,gamemode=adventure,scores={AC_bwrKills=1..}] AC_sillyPointsHeld 15
...
execute if score bwr AC_running matches 1 if score bwr1 AC_functions matches 1 run execute if score InGame AC_playercount matches 1 run scoreboard players add @a[tag=InGame,gamemode=adventure,limit=1] AC_sillyPointsHeld 30
...
#execute if score bwr AC_running matches 1 if score bwr1 AC_functions matches 1 run execute as @a[advancements={ac:bwr_melee=true}] run function airconditioner:games/bwr/anti-melee
...
execute if score bwr AC_running matches 1 if score bwr AC_time matches -1 run function airconditioner:games/bwr/blockclear
...
execute if score bwr AC_running matches 1 if score bwr AC_time matches -1 run function airconditioner:base/endsound
...
execute if score bwr AC_running matches 1 if score bwr AC_time matches -61 run function airconditioner:auto/invoke
