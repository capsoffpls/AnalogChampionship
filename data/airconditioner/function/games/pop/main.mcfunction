...
execute if score pop AC_running matches 1 if score pop1 AC_functions matches 1 run function airconditioner:games/pop/pop-spawn
execute if score pop AC_running matches 1 if score pop1 AC_functions matches 1 run function airconditioner:games/pop/trail
...
execute if score pop AC_running matches 1 if score pop1 AC_functions matches 1 run execute as @a[scores={AC_popDeath=1..}] if entity @s run scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 5
...
execute if score pop AC_running matches 1 if score pop1 AC_functions matches 1 run execute as @a[gamemode=adventure,tag=InGame] if score InGame AC_playercount matches 1 run scoreboard players add @s AC_sillyPointsHeld 25
...
execute if score pop AC_running matches 1 if score pop AC_time matches 1060 run function airconditioner:base/endsound
...
execute if score pop AC_running matches 1 if score pop AC_time matches 1000 run function airconditioner:auto/invoke
