...
execute if score pgf AC_running matches 1 as @a[tag=InGame,gamemode=adventure] at @s if entity @s[y=53,dy=-15] run function airconditioner:games/pgf/tp-back
...
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 1 if score second AC_misc matches 4 positioned -2021.1 64 521 run function airconditioner:games/pgf/summon
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 1 if score second AC_misc matches 14 positioned -2021 64 521.1 run function airconditioner:games/pgf/summon

execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 2 if score second AC_misc matches 4 positioned -2021.1 64 479 run function airconditioner:games/pgf/summon
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 2 if score second AC_misc matches 14 positioned -2021 64 479.1 run function airconditioner:games/pgf/summon

execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 3 if score second AC_misc matches 4 positioned -1979.1 64 479 run function airconditioner:games/pgf/summon
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 3 if score second AC_misc matches 14 positioned -1979 64 479.1 run function airconditioner:games/pgf/summon

execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 4 if score second AC_misc matches 4 positioned -1979.1 64 521 run function airconditioner:games/pgf/summon
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 4 if score second AC_misc matches 14 positioned -1979 64 521.1 run function airconditioner:games/pgf/summon

execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 run function airconditioner:games/pgf/count-pigs

execute if score pgf AC_running matches 1 if score pgf AC_time matches 0 run function airconditioner:games/pgf/pick-winner
execute if score pgf AC_running matches 1 if score pgf AC_time matches 0 run gamemode spectator @a
execute if score pgf AC_running matches 1 if score pgf AC_time matches 0 run function airconditioner:base/endsound
...
execute if score pgf AC_running matches 1 if score pgf AC_time matches 0 run function airconditioner:base/remove-spawn-tags
...
execute if score pgf AC_running matches 1 if score pgf AC_time matches -60 run function airconditioner:auto/invoke
