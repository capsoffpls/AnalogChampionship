...
execute if score #winners AC_pgfCount matches 1 run scoreboard players add @a[tag=pgfWinner] AC_sillyPointsHeld 30
...
execute if score #winners AC_pgfCount matches 2.. run scoreboard players add @a[tag=pgfWinner] AC_sillyPointsHeld 15
