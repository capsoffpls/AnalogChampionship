execute if score omc AC_running matches 1 if score omc AC_time matches -60 run function airconditioner:games/omc/round-prepare
...
execute if score omc AC_running matches 1 if score omc AC_time matches 1200 unless score modifier AC_omcRNG matches 30 run execute if score round AC_omcRound matches 2..5 run function airconditioner:games/omc/rng/modifier
...
execute if score omc AC_running matches 1 if score omc AC_time matches 2060 run function airconditioner:base/remove-spawn-tags
...
execute if score omc AC_running matches 1 if score omc AC_time matches 2060 run function airconditioner:base/endsound
...
execute if score omc AC_running matches 1 if score omc AC_time matches 2000 run function airconditioner:auto/invoke
...
execute as @a[tag=!omcDead,x=497,y=50,z=-1003,dx=6,dz=6,dy=6] if score tick AC_omc matches 5 run function airconditioner:games/omc/exchange/brick
execute as @a[tag=!omcDead,x=497,y=50,z=-1003,dx=6,dz=6,dy=6] if score tick AC_omc matches 5 run function airconditioner:games/omc/exchange/iron
execute as @a[tag=!omcDead,x=497,y=50,z=-1003,dx=6,dz=6,dy=6] if score tick AC_omc matches 5 run function airconditioner:games/omc/exchange/copper
