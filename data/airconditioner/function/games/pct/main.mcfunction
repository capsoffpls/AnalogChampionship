...
execute if score pct AC_running matches 1 if score pct AC_time matches 18200 run function airconditioner:games/pct/prepare
...
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score knights-m AC_pctInPoint matches 2.. run function airconditioner:games/pct/takeover/none-kl

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kl AC_pctInPoint matches 0 if score knights-kl AC_pctInPoint matches 0 run function airconditioner:games/pct/takeover/none-kl
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-l AC_pctInPoint matches 0 if score knights-l AC_pctInPoint matches 0 run function airconditioner:games/pct/takeover/none-l
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 0 if score knights-m AC_pctInPoint matches 0 run function airconditioner:games/pct/takeover/none-m
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-r AC_pctInPoint matches 0 if score knights-r AC_pctInPoint matches 0 run function airconditioner:games/pct/takeover/none-r
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kr AC_pctInPoint matches 0 if score knights-kr AC_pctInPoint matches 0 run function airconditioner:games/pct/takeover/none-kr

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 2.. run function airconditioner:games/pct/takeover/none-kr

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kl AC_pctInPoint matches 1.. if score knights-kl AC_pctInPoint matches 1.. run function airconditioner:games/pct/takeover/both-kl
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-l AC_pctInPoint matches 1.. if score knights-l AC_pctInPoint matches 1.. run function airconditioner:games/pct/takeover/both-l
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 1.. if score knights-m AC_pctInPoint matches 1.. run function airconditioner:games/pct/takeover/both-m
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-r AC_pctInPoint matches 1.. if score knights-r AC_pctInPoint matches 1.. run function airconditioner:games/pct/takeover/both-r
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kr AC_pctInPoint matches 1.. if score knights-kr AC_pctInPoint matches 1.. run function airconditioner:games/pct/takeover/both-kr

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-l AC_pctInPoint matches 1.. if score knights-l AC_pctInPoint matches 0 run function airconditioner:games/pct/takeover/hussars-l
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 1.. if score knights-m AC_pctInPoint matches 0 run function airconditioner:games/pct/takeover/hussars-m
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-r AC_pctInPoint matches 1.. if score knights-r AC_pctInPoint matches 0 run function airconditioner:games/pct/takeover/hussars-r
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kr AC_pctInPoint matches 1.. if score knights-kr AC_pctInPoint matches 0 if score knights-m AC_pctInPoint matches 0..1 run function airconditioner:games/pct/takeover/hussars-kr

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kl AC_pctInPoint matches 0 if score knights-kl AC_pctInPoint matches 1.. if score hussars-m AC_pctInPoint matches 0..1 run function airconditioner:games/pct/takeover/knights-kl
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-l AC_pctInPoint matches 0 if score knights-l AC_pctInPoint matches 1.. run function airconditioner:games/pct/takeover/knights-l
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 0 if score knights-m AC_pctInPoint matches 1.. run function airconditioner:games/pct/takeover/knights-m
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-r AC_pctInPoint matches 0 if score knights-r AC_pctInPoint matches 1.. run function airconditioner:games/pct/takeover/knights-r
...
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run function airconditioner:games/pct/passive-points
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run function airconditioner:games/pct/actionbar
...
execute if score pct AC_running matches 1 if score pct2 AC_functions matches 1 run execute as @a[scores={AC_pctDeaths=1..}] if entity @s run scoreboard players add @a[tag=InGame,gamemode=adventure,scores={AC_killmessage=1..}] AC_sillyPointsHeld 5
...
execute if score pct AC_running matches 1 if score pct2 AC_functions matches 1 run function airconditioner:games/pct/death-cooldown
...
execute if score pct AC_running matches 1 if score pct AC_time matches 0 run function airconditioner:base/endsound
...
execute if score pct AC_running matches 1 if score pct AC_time matches -60 run function airconditioner:base/remove-spawn-tags
...
execute if score pct AC_running matches 1 if score pct AC_time matches -60 run function airconditioner:auto/invoke
