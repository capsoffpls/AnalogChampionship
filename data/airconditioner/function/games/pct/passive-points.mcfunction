...
execute if score interval AC_pctTimer matches 300 if score l AC_pctPointStatus matches 1.. if score m AC_pctPointStatus matches 1.. if score r AC_pctPointStatus matches 1.. run scoreboard players add @a[team=ac_pctHussars] AC_sillyPointsHeld 10
...
execute if score interval AC_pctTimer matches 300 if score l AC_pctPointStatus matches ..-1 if score m AC_pctPointStatus matches ..-1 if score r AC_pctPointStatus matches ..-1 run scoreboard players add @a[team=ac_pctKnights] AC_sillyPointsHeld 10
...
execute if score interval AC_pctTimer matches 600 if score l AC_pctPointStatus matches 1.. run scoreboard players add @a[team=ac_pctHussars] AC_sillyPointsHeld 5
...
execute if score interval AC_pctTimer matches 600 if score l AC_pctPointStatus matches 1.. if score m AC_pctPointStatus matches 1.. run scoreboard players add @a[team=ac_pctHussars] AC_sillyPointsHeld 10
...
execute if score interval AC_pctTimer matches 600 if score l AC_pctPointStatus matches 1.. if score m AC_pctPointStatus matches 1.. if score r AC_pctPointStatus matches 1.. run scoreboard players add @a[team=ac_pctHussars] AC_sillyPointsHeld 15
...
execute if score interval AC_pctTimer matches 600 if score r AC_pctPointStatus matches ..-1 run scoreboard players add @a[team=ac_pctKnights] AC_sillyPointsHeld 5
...
execute if score interval AC_pctTimer matches 600 if score r AC_pctPointStatus matches ..-1 if score m AC_pctPointStatus matches ..-1 run scoreboard players add @a[team=ac_pctKnights] AC_sillyPointsHeld 10
...
execute if score interval AC_pctTimer matches 600 if score r AC_pctPointStatus matches ..-1 if score m AC_pctPointStatus matches ..-1 if score l AC_pctPointStatus matches ..-1 run scoreboard players add @a[team=ac_pctKnights] AC_sillyPointsHeld 15
