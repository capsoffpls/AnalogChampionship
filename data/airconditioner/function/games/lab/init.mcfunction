...
function airconditioner:base/add-spawntags
function airconditioner:base/protip
execute as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/lab/givetools
...
execute positioned -1460 70 2013 run function airconditioner:games/lab/generate
