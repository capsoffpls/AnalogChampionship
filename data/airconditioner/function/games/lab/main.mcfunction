...
execute if score lab AC_running matches 1 run execute if score lab AC_time matches 1800 run function airconditioner:games/lab/start
...
execute if score lab AC_running matches 1 if score lab1 AC_functions matches 1 run execute as @a[tag=InGame,x=-1518,y=3,z=1982,dy=2,dx=36,dz=36,tag=!labFinished] run function airconditioner:games/lab/finished
...
execute if score lab AC_running matches 1 run execute if score lab AC_time matches -1 run function airconditioner:base/endsound
execute if score lab AC_running matches 1 run execute if score lab AC_time matches -1 run function airconditioner:base/remove-spawn-tags
...
execute if score lab AC_running matches 1 run execute if score lab AC_time matches -61 run function airconditioner:auto/invoke
