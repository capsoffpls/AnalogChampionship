...
execute if entity @a[gamemode=spectator,scores={AC_mmcDeathCheck=1..}] as @a[tag=mmcSafe,gamemode=adventure] run scoreboard players operation @s AC_sillyPointsHeld += @s AC_pointBuffer
