...
execute if score mmc AC_running matches 1 run execute if score mmc AC_time matches 400 run function airconditioner:games/mmc/round-advance

execute if score mmc AC_running matches 1 run execute if score mmc AC_time matches 100 run function airconditioner:games/mmc/summon-carts
...
execute if score mmc AC_running matches 1 run execute if score mmc AC_time matches 0 run function airconditioner:games/mmc/kill

execute if score mmc AC_running matches 1 run execute if score mmc AC_time matches -20 if score InGame AC_playercount matches 2.. run function airconditioner:games/mmc/round-advance
execute if score mmc AC_running matches 1 run execute if score mmc AC_time matches -20 if score InGame AC_playercount matches 1 run function airconditioner:games/mmc/end-win
execute if score mmc AC_running matches 1 run execute if score mmc AC_time matches -20 if score InGame AC_playercount matches 0 run function airconditioner:games/mmc/end-draw
...
execute if score mmc AC_running matches 1 run execute if score mmc AC_time matches -400 run function airconditioner:base/endsound
...
execute if score mmc AC_running matches 1 run execute if score mmc AC_time matches -460 run function airconditioner:auto/invoke
