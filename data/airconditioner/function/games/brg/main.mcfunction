execute if score brg AC_running matches 1 if score brg AC_time matches 6100 run function airconditioner:games/brg/tp-to-boxes
...
execute if score brg AC_running matches 1 if score brg AC_time matches 6000 run execute as @a run function airconditioner:games/brg/give-items
...
execute if score brg AC_running matches 1 if score brg1 AC_functions matches 1 run execute as @a if score @s AC_deathmessage matches 1.. run function airconditioner:games/brg/death

execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run function airconditioner:games/brg/goal-particles
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run execute as @a[x=1498,y=98,z=-44,dx=4,dz=4,gamemode=adventure,tag=InGame] if entity @s run function airconditioner:games/brg/score-red
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run execute as @a[x=1540,y=98,z=-2,dx=4,dz=4,gamemode=adventure,tag=InGame] if entity @s run function airconditioner:games/brg/score-yellow
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run execute as @a[x=1498,y=98,z=40,dx=4,dz=4,gamemode=adventure,tag=InGame] if entity @s run function airconditioner:games/brg/score-green
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run execute as @a[x=1456,y=98,z=-2,dx=4,dz=4,gamemode=adventure,tag=InGame] if entity @s run function airconditioner:games/brg/score-blue
...
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 if score red AC_brgScore matches 0 if score red AC_brgPlayersLeft matches 0 run function airconditioner:games/brg/team-outlived {team:"red"}
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 if score yellow AC_brgScore matches 0 if score yellow AC_brgPlayersLeft matches 0 run function airconditioner:games/brg/team-outlived {team:"yellow"}
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 if score green AC_brgScore matches 0 if score green AC_brgPlayersLeft matches 0 run function airconditioner:games/brg/team-outlived {team:"green"}
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 if score blue AC_brgScore matches 0 if score blue AC_brgPlayersLeft matches 0 run function airconditioner:games/brg/team-outlived {team:"blue"}

execute if score brg AC_running matches 1 if score brg AC_time matches -2399..5900 run execute if score yellow AC_brgPlayersLeft matches 0 if score blue AC_brgPlayersLeft matches 0 if score green AC_brgPlayersLeft matches 0 run function airconditioner:games/brg/end-red
execute if score brg AC_running matches 1 if score brg AC_time matches -2399..5900 run execute if score red AC_brgPlayersLeft matches 0 if score blue AC_brgPlayersLeft matches 0 if score green AC_brgPlayersLeft matches 0 run function airconditioner:games/brg/end-yellow
execute if score brg AC_running matches 1 if score brg AC_time matches -2399..5900 run execute if score red AC_brgPlayersLeft matches 0 if score blue AC_brgPlayersLeft matches 0 if score yellow AC_brgPlayersLeft matches 0 run function airconditioner:games/brg/end-green
execute if score brg AC_running matches 1 if score brg AC_time matches -2399..5900 run execute if score red AC_brgPlayersLeft matches 0 if score yellow AC_brgPlayersLeft matches 0 if score green AC_brgPlayersLeft matches 0 run function airconditioner:games/brg/end-blue
...
execute if score brg AC_running matches 1 if score brg AC_time matches -2400 run function airconditioner:base/endsound
...
execute if score brg AC_running matches 1 if score brg AC_time matches -2400 run function airconditioner:base/remove-spawn-tags
...
execute if score brg AC_running matches 1 if score brg AC_time matches -2460 run function airconditioner:auto/invoke
