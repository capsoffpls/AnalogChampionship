...
execute if score tbk AC_running matches 1 if score tbk AC_time matches 12000 run function airconditioner:games/tbk/items

execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 run function airconditioner:games/tbk/fly
execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 run function airconditioner:games/tbk/health
...
execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 run function airconditioner:games/tbk/snowball/main
...
execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 as @a[scores={AC_tbkDeath=1..},tag=!tobiko,gamemode=adventure] if entity @s run scoreboard players add @a[tag=tobiko] AC_sillyPointsHeld 5
...
execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 as @a if entity @s[advancements={ac:tbk_arrowhit=true},tag=!tobiko] run scoreboard players add @s AC_sillyPointsHeld 5
...
execute if score tbk AC_running matches 1 if score tbk AC_time matches 0 run scoreboard players add @a[tag=!tobiko,gamemode=adventure] AC_sillyPointsHeld 30
...
execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 as @a[scores={AC_tbkDeath=1..},tag=tobiko] if entity @s run scoreboard players add @a[tag=!tobiko,gamemode=adventure] AC_sillyPointsHeld 40
...
execute if score tbk AC_running matches 1 if score tbk AC_time matches 1.. if score health AC_tbkScores matches 0 run scoreboard players add @a[tag=!tobiko,gamemode=adventure] AC_sillyPointsHeld 40
...
execute if score tbk AC_running matches 1 if score tbk AC_time matches 1.. unless entity @a[gamemode=adventure,tag=!tobiko] run scoreboard players add @a[tag=tobiko] AC_sillyPointsHeld 50
...
execute if score tbk AC_running matches 1 if score tbk AC_time matches 0 run function airconditioner:base/endsound
execute if score tbk AC_running matches 1 if score tbk AC_time matches 0 run gamemode spectator @a
execute if score tbk AC_running matches 1 if score tbk AC_time matches 0 run execute as @a run function airconditioner:menu/reset-attributes
...
execute if score tbk AC_running matches 1 if score tbk AC_time matches -120 run function airconditioner:auto/invoke
