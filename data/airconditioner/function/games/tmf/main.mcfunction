...
execute if score tmf AC_running matches 1 run execute if score tmf AC_time matches 6000 run execute as @a[tag=InGame,tag=!spawn17] run function airconditioner:games/tmf/give-items
...
execute if score tmf AC_running matches 1 run execute if score tmf AC_time matches 6000 run function airconditioner:games/tmf/assign-teams
...
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute as @a[tag=tmfDead] unless score @s AC_tmfLives matches ..0 run function airconditioner:games/tmf/respawn-cooldown
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute as @a[scores={AC_deathmessage=1..},gamemode=adventure] if entity @s run function airconditioner:games/tmf/death
...
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 if score team1 AC_tmfAlive matches 0 unless score team1 AC_tmfRankedTeamPlace matches 1..8 run function airconditioner:games/tmf/team-eliminated {team:1}
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 if score team2 AC_tmfAlive matches 0 unless score team2 AC_tmfRankedTeamPlace matches 1..8 run function airconditioner:games/tmf/team-eliminated {team:2}
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 if score team3 AC_tmfAlive matches 0 unless score team3 AC_tmfRankedTeamPlace matches 1..8 run function airconditioner:games/tmf/team-eliminated {team:3}
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 if score team4 AC_tmfAlive matches 0 unless score team4 AC_tmfRankedTeamPlace matches 1..8 run function airconditioner:games/tmf/team-eliminated {team:4}
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 if score team5 AC_tmfAlive matches 0 unless score team5 AC_tmfRankedTeamPlace matches 1..8 run function airconditioner:games/tmf/team-eliminated {team:5}
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 if score team6 AC_tmfAlive matches 0 unless score team6 AC_tmfRankedTeamPlace matches 1..8 run function airconditioner:games/tmf/team-eliminated {team:6}
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 if score team7 AC_tmfAlive matches 0 unless score team7 AC_tmfRankedTeamPlace matches 1..8 run function airconditioner:games/tmf/team-eliminated {team:7}
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 if score team8 AC_tmfAlive matches 0 unless score team8 AC_tmfRankedTeamPlace matches 1..8 run function airconditioner:games/tmf/team-eliminated {team:8}

execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 1.. if score team2 AC_tmfAlive matches 0 if score team3 AC_tmfAlive matches 0 if score team4 AC_tmfAlive matches 0 if score team5 AC_tmfAlive matches 0 if score team6 AC_tmfAlive matches 0 if score team7 AC_tmfAlive matches 0 if score team8 AC_tmfAlive matches 0 run function airconditioner:games/tmf/end-t1
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 0 if score team2 AC_tmfAlive matches 1.. if score team3 AC_tmfAlive matches 0 if score team4 AC_tmfAlive matches 0 if score team5 AC_tmfAlive matches 0 if score team6 AC_tmfAlive matches 0 if score team7 AC_tmfAlive matches 0 if score team8 AC_tmfAlive matches 0 run function airconditioner:games/tmf/end-t2
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 0 if score team2 AC_tmfAlive matches 0 if score team3 AC_tmfAlive matches 1.. if score team4 AC_tmfAlive matches 0 if score team5 AC_tmfAlive matches 0 if score team6 AC_tmfAlive matches 0 if score team7 AC_tmfAlive matches 0 if score team8 AC_tmfAlive matches 0 run function airconditioner:games/tmf/end-t3
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 0 if score team2 AC_tmfAlive matches 0 if score team3 AC_tmfAlive matches 0 if score team4 AC_tmfAlive matches 1.. if score team5 AC_tmfAlive matches 0 if score team6 AC_tmfAlive matches 0 if score team7 AC_tmfAlive matches 0 if score team8 AC_tmfAlive matches 0 run function airconditioner:games/tmf/end-t4
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 0 if score team2 AC_tmfAlive matches 0 if score team3 AC_tmfAlive matches 0 if score team4 AC_tmfAlive matches 0 if score team5 AC_tmfAlive matches 1.. if score team6 AC_tmfAlive matches 0 if score team7 AC_tmfAlive matches 0 if score team8 AC_tmfAlive matches 0 run function airconditioner:games/tmf/end-t5
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 0 if score team2 AC_tmfAlive matches 0 if score team3 AC_tmfAlive matches 0 if score team4 AC_tmfAlive matches 0 if score team5 AC_tmfAlive matches 0 if score team6 AC_tmfAlive matches 1.. if score team7 AC_tmfAlive matches 0 if score team8 AC_tmfAlive matches 0 run function airconditioner:games/tmf/end-t6
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 0 if score team2 AC_tmfAlive matches 0 if score team3 AC_tmfAlive matches 0 if score team4 AC_tmfAlive matches 0 if score team5 AC_tmfAlive matches 0 if score team6 AC_tmfAlive matches 0 if score team7 AC_tmfAlive matches 1.. if score team8 AC_tmfAlive matches 0 run function airconditioner:games/tmf/end-t7
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 0 if score team2 AC_tmfAlive matches 0 if score team3 AC_tmfAlive matches 0 if score team4 AC_tmfAlive matches 0 if score team5 AC_tmfAlive matches 0 if score team6 AC_tmfAlive matches 0 if score team7 AC_tmfAlive matches 0 if score team8 AC_tmfAlive matches 1.. run function airconditioner:games/tmf/end-t8
execute if score tmf AC_running matches 1 if score tmf1 AC_functions matches 1 run execute if score team1 AC_tmfAlive matches 0 if score team2 AC_tmfAlive matches 0 if score team3 AC_tmfAlive matches 0 if score team4 AC_tmfAlive matches 0 if score team5 AC_tmfAlive matches 0 if score team6 AC_tmfAlive matches 0 if score team7 AC_tmfAlive matches 0 if score team8 AC_tmfAlive matches 0 run function airconditioner:games/tmf/end-draw
...
execute if score tmf AC_running matches 1 if score tmf AC_time matches -12001 run function airconditioner:base/remove-spawn-tags
...
execute if score tmf AC_running matches 1 if score tmf AC_time matches -12001 run function airconditioner:base/endsound
...
execute if score tmf AC_running matches 1 if score tmf AC_time matches -12061 run function airconditioner:auto/invoke
