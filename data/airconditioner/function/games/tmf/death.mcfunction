...
scoreboard players add @a[tag=InGame,gamemode=adventure,scores={AC_killmessage=1..}] AC_sillyPointsHeld 10
...
execute if score @s AC_tmfLives matches 0 run scoreboard players add @a[tag=InGame,gamemode=adventure,scores={AC_killmessage=1..}] AC_sillyPointsHeld 15
