...
function airconditioner:games/bed/rng/map
...
weather clear
time set day
function airconditioner:games/bed/clear
...
function airconditioner:base/reset-locator-bar
function airconditioner:games/bed/setup-locator-bar
