execute if score bed AC_running matches 1 run execute if score bed AC_time matches 36100 run function airconditioner:games/bed/prepare
...
execute if score bed AC_running matches 1 run execute as @a[tag=InGame,gamemode=!spectator] if score @s AC_bedCurrentY matches 50.. run function airconditioner:games/bed/update_currency

execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 1 run function airconditioner:games/bed/shops
execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 6 run function airconditioner:games/bed/shops
execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 11 run function airconditioner:games/bed/shops
execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 16 run function airconditioner:games/bed/shops

execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 13 run function airconditioner:games/bed/stock_items
...
execute if score bed AC_running matches 1 run execute if score bed2 AC_functions matches 1 run execute if score second AC_bedTimer matches 11 run execute as @a[tag=InGame,tag=!bedDead,tag=!drankInvis] run function airconditioner:games/bed/give_armor
...
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute if score bed AC_chosenMap matches 0 unless block 1448 56 -952 red_bed as @a[tag=InGame,team=ac_bedRed] unless entity @s[tag=bedDestroyed] unless entity @s[tag=bedDead] run function airconditioner:games/bed/bed_destroyed
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute if score bed AC_chosenMap matches 0 unless block 1452 56 -1052 yellow_bed as @a[tag=InGame,team=ac_bedYellow] unless entity @s[tag=bedDestroyed] unless entity @s[tag=bedDead] run function airconditioner:games/bed/bed_destroyed
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute if score bed AC_chosenMap matches 0 unless block 1552 56 -1048 lime_bed as @a[tag=InGame,team=ac_bedGreen] unless entity @s[tag=bedDestroyed] unless entity @s[tag=bedDead] run function airconditioner:games/bed/bed_destroyed
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute if score bed AC_chosenMap matches 0 unless block 1548 56 -948 blue_bed as @a[tag=InGame,team=ac_bedBlue] unless entity @s[tag=bedDestroyed] unless entity @s[tag=bedDead] run function airconditioner:games/bed/bed_destroyed
...
execute if score bed AC_running matches 1 run execute if score bed6 AC_functions matches 1 run execute as @a[tag=!drankInvis] if entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] run function airconditioner:games/bed/invis
...
execute if score bed AC_running matches 1 run execute if score bed6 AC_functions matches 1 run execute as @a[tag=drankInvis] unless entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] run function airconditioner:games/bed/give_armor
...
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 1..35500 if score yellow AC_bedPlayersLeft matches 0 if score blue AC_bedPlayersLeft matches 0 if score green AC_bedPlayersLeft matches 0 run function airconditioner:games/bed/end_red
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 1..35500 if score red AC_bedPlayersLeft matches 0 if score blue AC_bedPlayersLeft matches 0 if score green AC_bedPlayersLeft matches 0 run function airconditioner:games/bed/end_yellow
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 1..35500 if score red AC_bedPlayersLeft matches 0 if score blue AC_bedPlayersLeft matches 0 if score yellow AC_bedPlayersLeft matches 0 run function airconditioner:games/bed/end_green
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 1..35500 if score red AC_bedPlayersLeft matches 0 if score yellow AC_bedPlayersLeft matches 0 if score green AC_bedPlayersLeft matches 0 run function airconditioner:games/bed/end_blue
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 0 run function airconditioner:games/bed/end_timeout
...
execute if score bed AC_running matches 1 run execute if score bed AC_time matches -1 run function airconditioner:base/endsound
...
execute if score bed AC_running matches 1 run execute if score bed AC_time matches -1 run function airconditioner:games/bed/reset_message_control
...
execute if score bed AC_running matches 1 run execute if score bed AC_time matches -61 run function airconditioner:auto/invoke
