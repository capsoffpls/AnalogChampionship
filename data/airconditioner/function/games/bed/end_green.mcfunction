...
scoreboard players add @a[tag=InGame,team=ac_bedGreen,tag=!bedDead] AC_sillyPointsHeld 50
...
scoreboard players add @a[tag=InGame,team=ac_bedGreen,tag=bedDead] AC_sillyPointsHeld 20
