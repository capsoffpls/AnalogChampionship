...
execute if score @s AC_bedAxe matches 3 if score @s AC_bedGold matches 15.. run function airconditioner:games/bed/shopping-items/diamond_axe
...
execute if score @s AC_bedAxe matches 2 if score @s AC_bedGold matches 8.. run function airconditioner:games/bed/shopping-items/iron_axe
...
execute if score @s AC_bedAxe matches 1 if score @s AC_bedIron matches 25.. run function airconditioner:games/bed/shopping-items/stone_axe
...
execute if score @s AC_bedAxe matches 0 if score @s AC_bedIron matches 25.. run function airconditioner:games/bed/shopping-items/wooden_axe
