...
execute if score round AC_jgtScores matches 1 as @r[tag=jgtRound1] run function airconditioner:games/jgt/make-juggernaut
execute if score round AC_jgtScores matches 1 as @a[tag=!spawn1,tag=jgtRound1] run function airconditioner:games/jgt/equip-hunters
...
execute if score round AC_jgtScores matches 2 as @r[tag=jgtRound2] run function airconditioner:games/jgt/make-juggernaut
execute if score round AC_jgtScores matches 2 as @a[tag=!spawn2,tag=jgtRound2] run function airconditioner:games/jgt/equip-hunters
