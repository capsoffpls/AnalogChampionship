execute if score jgt AC_running matches 1 if score jgt AC_time matches 3250 run function airconditioner:games/jgt/round-advance
...
execute if score jgt AC_running matches 1 as @a[tag=!jgtJuggernaut,scores={AC_jgtHitDetect=100..},gamemode=adventure] run scoreboard players add @s AC_sillyPointsHeld 2
...
execute if score jgt AC_running matches 1 as @a[tag=jgtJuggernaut,scores={AC_killmessage=1..}] run scoreboard players add @s AC_sillyPointsHeld 10
...
execute if score jgt AC_running matches 1 as @a[scores={AC_deathmessage=1..},tag=jgtJuggernaut] run scoreboard players add @a[tag=!jgtJuggernaut,tag=InGame,gamemode=adventure] AC_sillyPointsHeld 35
...
execute if score jgt AC_running matches 1 as @a[scores={AC_deathmessage=1..},tag=jgtJuggernaut] run scoreboard players add @a[tag=!jgtJuggernaut,tag=InGame,gamemode=adventure,scores={AC_killmessage=1..}] AC_sillyPointsHeld 15
...
execute if score jgt AC_running matches 1 if score jgt AC_time matches 0 as @a[tag=jgtJuggernaut,gamemode=adventure] if entity @s run scoreboard players add @s AC_sillyPointsHeld 50
...
execute if score jgt AC_running matches 1 if score jgt AC_time matches -1000 run function airconditioner:base/endsound
...
execute if score jgt AC_running matches 1 if score jgt AC_time matches -1060 run function airconditioner:auto/invoke
