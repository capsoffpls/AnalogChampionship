...
execute if score round AC_blpRound matches 2.. run scoreboard players add @a[tag=InGame,gamemode=adventure,x=969,y=51,z=-531,dx=62,dy=2,dz=62] AC_sillyPointsHeld 5
