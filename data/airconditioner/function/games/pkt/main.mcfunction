execute if score pkt AC_running matches 1 if score pkt AC_time matches 2000 run function airconditioner:games/pkt/round-advance
...
execute if score pkt AC_running matches 1 if score pkt1 AC_functions matches 1 run function airconditioner:games/pkt/eliminate

execute if score pkt AC_running matches 1 if score pkt1 AC_functions matches 1 run execute unless entity @a[tag=InGame,gamemode=adventure,tag=!pktHunter] run function airconditioner:games/pkt/hunters-win

execute if score pkt AC_running matches 1 if score pkt1 AC_functions matches 1 run execute if score pkt AC_time matches 0 run function airconditioner:games/pkt/runners-win
...
execute if score pkt AC_running matches 1 run execute if score pkt AC_time matches -1000 run function airconditioner:base/remove-spawn-tags
...
execute if score pkt AC_running matches 1 run execute if score pkt AC_time matches -1000 run function airconditioner:base/endsound
...
execute if score pkt AC_running matches 1 run execute if score pkt AC_time matches -1060 run function airconditioner:auto/invoke
