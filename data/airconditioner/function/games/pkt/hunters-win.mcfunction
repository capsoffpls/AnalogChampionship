scoreboard players add @a[tag=InGame,gamemode=adventure,tag=pktHunter] AC_sillyPointsHeld 40
...
execute if score round AC_pktScores matches 1 run scoreboard players add @a[tag=InGame,team=ac_pktClimbers] AC_sillyPointsHeld 10
...
execute if score round AC_pktScores matches 2 run scoreboard players add @a[tag=InGame,team=ac_pktJumpers] AC_sillyPointsHeld 10
...
execute if score round AC_pktScores matches 3 run scoreboard players add @a[tag=InGame,team=ac_pktClimbers] AC_sillyPointsHeld 10
...
execute if score round AC_pktScores matches 4 run scoreboard players add @a[tag=InGame,team=ac_pktJumpers] AC_sillyPointsHeld 10
...
execute if score round AC_pktScores matches 5 run scoreboard players add @a[tag=InGame,team=ac_pktClimbers] AC_sillyPointsHeld 10
...
execute if score round AC_pktScores matches 6 run scoreboard players add @a[tag=InGame,team=ac_pktJumpers] AC_sillyPointsHeld 10
