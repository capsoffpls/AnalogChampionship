...
execute if score spl AC_time matches -1 run function airconditioner:base/endsound
...
execute if score spl AC_time matches -60 run function airconditioner:auto/invoke
