execute if score mtl AC_running matches 1 if score mtl AC_time matches 1360 run function airconditioner:games/mtl/prepare
execute if score mtl AC_running matches 1 if score mtl AC_time matches 0..1360 run function airconditioner:games/mtl/ride
...
execute if score mtl AC_running matches 1 as @a[tag=InGame] if score @s AC_mtlGrassToPoints matches 5.. run scoreboard players add @s AC_sillyPointsHeld 1
...
execute if score mtl AC_running matches 1 if score mtl AC_time matches 0 run execute as @a[tag=InGame] if score @s AC_mtlTotalGrassDestroyed = #highest AC_mtlTotalGrassDestroyed run scoreboard players add @s AC_sillyPointsHeld 20
...
execute if score mtl AC_running matches 1 if score mtl AC_time matches 0 run function airconditioner:base/endsound
...
execute if score mtl AC_running matches 1 if score mtl AC_time matches -61 run function airconditioner:auto/invoke
