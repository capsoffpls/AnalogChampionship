...
execute if score mfl AC_running matches 1 if score mfl1 AC_functions matches 1 run execute as @e[x=51,y=51,z=983,dz=35,dx=1,gamemode=adventure] run function airconditioner:games/mfl/reward
...
execute if score mfl AC_running matches 1 if score mfl2 AC_functions matches 1 run execute as @a if score @s AC_deathmessage matches 1.. run scoreboard players add @a[tag=!mflDead,tag=InGame] AC_sillyPointsHeld 10
...
execute if score mfl AC_running matches 1 if score mfl AC_time matches -1 run function airconditioner:base/endsound
execute if score mfl AC_running matches 1 if score mfl AC_time matches -1 run function airconditioner:base/remove-spawn-tags
...
execute if score mfl AC_running matches 1 if score mfl AC_time matches -61 run function airconditioner:auto/invoke
