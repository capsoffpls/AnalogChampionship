...
execute if score @s AC_cstRespawnTime matches ..0 if entity @s[tag=cstArsonist] run function airconditioner:games/cst/kits/arsonist
execute if score @s AC_cstRespawnTime matches ..0 if entity @s[tag=cstAssassin] run function airconditioner:games/cst/kits/assassin
execute if score @s AC_cstRespawnTime matches ..0 if entity @s[tag=cstRebel] run function airconditioner:games/cst/kits/rebel
execute if score @s AC_cstRespawnTime matches ..0 if entity @s[tag=cstScout] run function airconditioner:games/cst/kits/scout
execute if score @s AC_cstRespawnTime matches ..0 if entity @s[tag=cstShooter] run function airconditioner:games/cst/kits/shooter
execute if score @s AC_cstRespawnTime matches ..0 if entity @s[tag=cstSniper] run function airconditioner:games/cst/kits/sniper
execute if score @s AC_cstRespawnTime matches ..0 if entity @s[tag=cstTank] run function airconditioner:games/cst/kits/tank
execute if score @s AC_cstRespawnTime matches ..0 if entity @s[tag=cstWarrior] run function airconditioner:games/cst/kits/warrior
