...
execute as @e[type=armor_stand,tag=cstWarrior] run function airconditioner:games/cst/kits/warrior
execute as @e[type=armor_stand,tag=cstAssassin] run function airconditioner:games/cst/kits/assassin
execute as @e[type=armor_stand,tag=cstScout] run function airconditioner:games/cst/kits/scout
execute as @e[type=armor_stand,tag=cstSniper] run function airconditioner:games/cst/kits/sniper
execute as @e[type=armor_stand,tag=cstTank] run function airconditioner:games/cst/kits/tank
execute as @e[type=armor_stand,tag=cstShooter] run function airconditioner:games/cst/kits/shooter
execute as @e[type=armor_stand,tag=cstRebel] run function airconditioner:games/cst/kits/rebel
execute as @e[type=armor_stand,tag=cstArsonist] run function airconditioner:games/cst/kits/arsonist