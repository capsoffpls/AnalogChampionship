execute as @e[type=interaction,tag=cstKitInteraction] on attacker at @s run playsound minecraft:entity.item.pickup master @s

execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass1] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Klasa ogólna: Wojownik.\n","color":"green","bold":false},\
...
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass1] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Common class: Warrior.\n","color":"green","bold":false},\
...
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass2] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Klasa ogólna: Asasyn.\n","color":"green","bold":false},\
...
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass2] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Common class: Assassin.\n","color":"green","bold":false},\
...
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass3] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Klasa ogólna: Skaut.\n","color":"green","bold":false},\
...
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass3] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Common class: Scout.\n","color":"green","bold":false},\
...
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass4] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Klasa ogólna: Snajper.\n","color":"green","bold":false},\
{"text":"Zdrowie: ",bold:true,color:dark_green},{text:"20\n",bold:false,color:red},\
{"text":"Skala: ",bold:true,color:dark_green},{text:"1\n",bold:false,color:red},\
...
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass5] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Klasa Atakujących: Rebeliant.\n","color":"blue","bold":false},\
...
{text:"\n- Drewniana siekiera",bold:false,color:red,hover_event:{action:"show_item",id:wooden_axe,components:{unbreakable:{}}}},\
...
{text:"\n- Pieczona wołowina x16",bold:false,color:red,hover_event:{action:"show_item",id:cooked_beef,count:16}},\
{text:"\n- Złote jabłko x5",bold:false,color:red,hover_event:{action:"show_item",id:golden_apple,count:5}}]
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass5] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Attackers' class: Rebel.\n","color":"blue","bold":false},\
...
{text:"\n- Wooden Axe",bold:false,color:red,hover_event:{action:"show_item",id:wooden_axe,components:{unbreakable:{}}}},\
...
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass6] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Klasa Atakujących: Arsonista.\n","color":"blue","bold":false},\
{"text":"Zdrowie: ",bold:true,color:dark_green},{text:"20\n",bold:false,color:red},\
{"text":"Skala: ",bold:true,color:dark_green},{text:"1\n",bold:false,color:red},\
...
{text:"\n- Strzała x32",bold:false,color:red,hover_event:{action:"show_item",id:arrow,count:16}},\
{text:"\n- Pieczona wołowina x16",bold:false,color:red,hover_event:{action:"show_item",id:cooked_beef,count:16}},\
...
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass6] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Attackers' class: Arsonist.\n","color":"blue","bold":false},\
{"text":"Health: ",bold:true,color:dark_green},{text:"20\n",bold:false,color:red},\
{"text":"Scale: ",bold:true,color:dark_green},{text:"1\n",bold:false,color:red},\
...
{text:"\n- Arrow x32",bold:false,color:red,hover_event:{action:"show_item",id:arrow,count:16}},\
{text:"\n- Cooked Beef x16",bold:false,color:red,hover_event:{action:"show_item",id:cooked_beef,count:16}},\
{text:"\n- Golden Apple x3",bold:false,color:red,hover_event:{action:"show_item",id:golden_apple,count:3}},\
{text:"\n- Fajerwerki x10",bold:false,color:red,hover_event:{action:"show_item",id:firework_rocket,components:{fireworks:{flight_duration:10,explosions:[{shape:large_ball,has_trail:1b,colors:[16776960,16746240]},{shape:large_ball,has_trail:0b,colors:[16776960,16746240]},{shape:large_ball,has_trail:0b,colors:[16776960,16746240]},{shape:large_ball,has_trail:0b,colors:[16776960,16746240]}]}},count:10}}]

execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass7] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Klasa Obrońców: Tank.\n","color":"white","bold":false},\
{"text":"Zdrowie: ",bold:true,color:dark_green},{text:"40\n",bold:false,color:red},\
{"text":"Skala: ",bold:true,color:dark_green},{text:"1.75\n",bold:false,color:red},\
{"text":"Knockback Resistance: ",bold:true,color:dark_green},{text:"40%\n",bold:false,color:red},\
{"text":"Efekty: ",bold:true,color:dark_green},{text:"brak\n",bold:false,color:red},\
{"text":"Pasywne: ",bold:true,color:dark_green},{text:"Tank przejmuje 40% obrażeń członków drużyny znajdujących się w pobliżu 32 bloków.\n",bold:false,color:red},\
{"text":"\nZbroja: ",bold:true,color:dark_green},\
...
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass7] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Defenders' class: Tank.\n","color":"white","bold":false},\
{"text":"Health: ",bold:true,color:dark_green},{text:"40\n",bold:false,color:red},\
{"text":"Scale: ",bold:true,color:dark_green},{text:"1.75\n",bold:false,color:red},\
{"text":"Knockback Resistance: ",bold:true,color:dark_green},{text:"40%\n",bold:false,color:red},\
{"text":"Effect: ",bold:true,color:dark_green},{text:"none\n",bold:false,color:red},\
{"text":"Passive: ",bold:true,color:dark_green},{text:"Tank takes 40% of damage inflicted against team members in proximity of 32 blocks.\n",bold:false,color:red},\
{"text":"\nArmor: ",bold:true,color:dark_green},\
...
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass8] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Klasa Obrońców: Strzelec.\n","color":"white","bold":false},\
{"text":"Zdrowie: ",bold:true,color:dark_green},{text:"20\n",bold:false,color:red},\
{"text":"Skala: ",bold:true,color:dark_green},{text:"1\n",bold:false,color:red},\
{"text":"Efekty: ",bold:true,color:dark_green},{text:"brak\n",bold:false,color:red},\
...
{text:"\n- Pieczona wołowina x16",bold:false,color:red,hover_event:{action:"show_item",id:cooked_beef,count:16}},\
{text:"\n- Złote jabłko x5",bold:false,color:red,hover_event:{action:"show_item",id:golden_apple,count:5}}]
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass8] on attacker run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Defenders' class: Shooter.\n","color":"white","bold":false},\
{"text":"Health: ",bold:true,color:dark_green},{text:"20\n",bold:false,color:red},\
{"text":"Scale: ",bold:true,color:dark_green},{text:"1\n",bold:false,color:red},\
{"text":"Effect: ",bold:true,color:dark_green},{text:"none\n",bold:false,color:red},\
...
execute as @e[type=interaction,tag=cstKitInteraction,tag=cstClass1] on target unless entity @s[tag=cstLockedIn] run function airconditioner:games/cst/kits/warrior
execute as @e[type=interaction,tag=cstKitInteraction,tag=cstClass2] on target unless entity @s[tag=cstLockedIn] run function airconditioner:games/cst/kits/assassin
execute as @e[type=interaction,tag=cstKitInteraction,tag=cstClass3] on target unless entity @s[tag=cstLockedIn] run function airconditioner:games/cst/kits/scout
execute as @e[type=interaction,tag=cstKitInteraction,tag=cstClass4] on target unless entity @s[tag=cstLockedIn] run function airconditioner:games/cst/kits/sniper

execute as @e[type=interaction,tag=cstKitInteraction,tag=cstClass5] on target unless entity @s[tag=cstLockedIn] run function airconditioner:games/cst/kits/rebel
execute as @e[type=interaction,tag=cstKitInteraction,tag=cstClass6] on target unless entity @s[tag=cstLockedIn] run function airconditioner:games/cst/kits/arsonist

execute as @e[type=interaction,tag=cstKitInteraction,tag=cstClass7] on target unless entity @s[tag=cstLockedIn] run function airconditioner:games/cst/kits/tank
execute as @e[type=interaction,tag=cstKitInteraction,tag=cstClass8] on target unless entity @s[tag=cstLockedIn] run function airconditioner:games/cst/kits/shooter
...
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass2] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Aby zmienić klasę, musisz zginąć.","color":"red","bold":false}]
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass2] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"You have to die in order to change class.","color":"red","bold":false}]
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass3] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Aby zmienić klasę, musisz zginąć.","color":"red","bold":false}]
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass3] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"You have to die in order to change class.","color":"red","bold":false}]
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass4] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Aby zmienić klasę, musisz zginąć.","color":"red","bold":false}]
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass4] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"You have to die in order to change class.","color":"red","bold":false}]
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass5] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Aby zmienić klasę, musisz zginąć.","color":"red","bold":false}]
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass5] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"You have to die in order to change class.","color":"red","bold":false}]
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass6] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Aby zmienić klasę, musisz zginąć.","color":"red","bold":false}]
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass6] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"You have to die in order to change class.","color":"red","bold":false}]
execute if score lang AC_lang matches 0 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass7] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"Aby zmienić klasę, musisz zginąć.","color":"red","bold":false}]
execute if score lang AC_lang matches 1 as @e[type=interaction,tag=cstKitInteraction,tag=cstClass7] on target if entity @s[tag=cstLockedIn] run tellraw @s [{"text":"[CST] ","bold":true,"color":"dark_green"},{"text":"You have to die in order to change class.","color":"red","bold":false}]
