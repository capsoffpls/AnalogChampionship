function airconditioner:games/cst/remove-kit
...
execute if entity @s[type=armor_stand] run item replace entity @s weapon with stone_sword[unbreakable={},enchantments={sharpness:2,fire_aspect:2}]