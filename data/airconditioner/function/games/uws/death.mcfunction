...
scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 10
...
execute if score InGame AC_playercount matches 2 run function airconditioner:games/uws/end-winner
execute if score InGame AC_playercount matches 1 run function airconditioner:games/uws/end-draw