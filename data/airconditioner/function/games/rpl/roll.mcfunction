execute if score roll AC_rplGeneration matches 0 run summon marker -1502 53.5 467 {Tags:["rplMarker1","rplMarker"]}
execute if score roll AC_rplGeneration matches 0 run summon marker -1502 53.5 501 {Tags:["rplMarker1","rplMarker"]}
execute if score roll AC_rplGeneration matches 0 run summon marker -1498 53.5 533 {Tags:["rplMarker2","rplMarker"]}
execute if score roll AC_rplGeneration matches 0 run summon marker -1498 53.5 499 {Tags:["rplMarker2","rplMarker"]}
execute if score roll AC_rplGeneration matches 0 run summon marker -1501 65.5 498 {Tags:["rplMarker3","rplMarker"]}
execute if score roll AC_rplGeneration matches 0 run summon marker -1499 65.5 502 {Tags:["rplMarker4","rplMarker"]}
...
execute if score roll AC_rplGeneration matches 1..25 run execute as @e[tag=rplMarker4] at @s unless block ~ ~ ~ polished_andesite run tp @s ~ ~ ~-1
...
execute if score roll AC_rplGeneration matches 1..25 run execute as @e[tag=rplMarker2] at @s if block ~ ~ ~ polished_andesite run tp @s ~5 ~1 ~
...
execute if score roll AC_rplGeneration matches 1..25 run execute as @e[tag=rplMarker4] at @s if block ~ ~ ~ polished_andesite run tp @s ~ ~1 ~5
...
function airconditioner:games/rpl/roll