execute if score rpl AC_running matches 1 if score rpl AC_time matches 1340 run function airconditioner:games/rpl/roll
...
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.0 with cobblestone[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.1 with blackstone[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.2 with cobbled_deepslate[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.3 with white_wool[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.4 with gold_block[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.5 with oak_planks[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.6 with netherrack[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.7 with prismarine_bricks[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
execute if score rpl AC_running matches 1 if score rpl AC_time matches 1200 run item replace entity @a[tag=InGame] hotbar.8 with end_stone[can_place_on={blocks:"#airconditioner:allblocks"},can_break={blocks:["cobblestone","blackstone","cobbled_deepslate","white_wool","gold_block","oak_planks","netherrack","prismarine_bricks","end_stone"]}] 64
...
execute if score rpl AC_running matches 1 if score rpl1 AC_functions matches 1 run execute as @a[tag=InGame] if entity @s[advancements={ac:rpl.blockplacement=true}] run function airconditioner:games/rpl/check
...
execute if score rpl AC_running matches 1 if score rpl AC_time matches 0 run function airconditioner:base/endsound
...
execute if score rpl AC_running matches 1 if score rpl AC_time matches -60 run function airconditioner:base/remove-spawn-tags
...
execute if score rpl AC_running matches 1 if score rpl AC_time matches -60 run function airconditioner:auto/invoke
