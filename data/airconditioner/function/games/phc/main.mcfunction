...
execute if score phc AC_running matches 1 if score phc1 AC_functions matches 1 as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/phc/spawn
...
execute if score phc AC_running matches 1 if score phc1 AC_functions matches 1 run execute as @a[gamemode=adventure,scores={AC_phcDeath=1..}] if entity @s run function airconditioner:games/phc/death

execute if score phc AC_running matches 1 if score phc AC_time matches ..0 run execute if score InGame AC_playercount matches 1 run function airconditioner:games/phc/end-winner
execute if score phc AC_running matches 1 if score phc AC_time matches ..0 run execute if score InGame AC_playercount matches 0 run function airconditioner:games/phc/end-nowinner
...
execute if score phc AC_running matches 1 if score phc AC_time matches 1060 run function airconditioner:base/endsound
...
execute if score phc AC_running matches 1 if score phc AC_time matches 1000 run function airconditioner:base/remove-spawn-tags
execute if score phc AC_running matches 1 if score phc AC_time matches 1000 run forceload remove -2018 -18 -1979 22
execute if score phc AC_running matches 1 if score phc AC_time matches 1000 run function airconditioner:auto/invoke
