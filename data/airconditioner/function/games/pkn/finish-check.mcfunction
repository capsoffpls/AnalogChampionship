...
execute if score round AC_pknScores matches 1 unless score round1 AC_pknScores matches 1.. if score pkn AC_time matches ..0 run function airconditioner:games/pkn/end
...
execute if score round AC_pknScores matches 2 unless score round2 AC_pknScores matches 1.. if score pkn AC_time matches ..0 run function airconditioner:games/pkn/end
...
execute if score round AC_pknScores matches 3 unless score round3 AC_pknScores matches 1.. if score pkn AC_time matches ..0 run function airconditioner:games/pkn/end
...
execute if score round AC_pknScores matches 4 unless score round4 AC_pknScores matches 1.. if score pkn AC_time matches ..0 run function airconditioner:games/pkn/end
...
execute if score round AC_pknScores matches 5 unless score round5 AC_pknScores matches 1.. if score pkn AC_time matches ..0 run function airconditioner:games/pkn/end
...
execute if score round AC_pknScores matches 6 unless score round6 AC_pknScores matches 1.. if score pkn AC_time matches ..0 run function airconditioner:games/pkn/end
...
execute if score round AC_pknScores matches 7 if score round7 AC_pknScores matches 2 run execute as @a[scores={AC_pknCheckpoint=..20},gamemode=adventure] run function airconditioner:games/pkn/eliminate
...
execute if score round AC_pknScores matches 7 if score round7 AC_pknScores matches 1 if score pkn AC_time matches ..0 run execute as @a[tag=InGame,gamemode=adventure,scores={AC_pknCheckpoint=..20}] run function airconditioner:games/pkn/eliminate
...
execute if score round AC_pknScores matches 7 if score round7 AC_pknScores matches 1 if score pkn AC_time matches ..0 run function airconditioner:games/pkn/end
...
execute if score round AC_pknScores matches 7 if score round7 AC_pknScores matches 0 if score pkn AC_time matches ..0 run execute as @a[tag=InGame,gamemode=adventure] run function airconditioner:games/pkn/eliminate
...
execute if score round AC_pknScores matches 7 if score round7 AC_pknScores matches 0 if score pkn AC_time matches ..0 run function airconditioner:games/pkn/end
