...
execute as @a[gamemode=adventure,tag=InGame] run scoreboard players operation @s AC_rankedPlaceFinished = current AC_rankedPlaceFinished
...
execute if score pkn AC_time matches -1.. run function airconditioner:base/endsound
