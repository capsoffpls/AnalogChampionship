execute if score pkn AC_running matches 1 if score round AC_pknScores matches 0..4 if score pkn AC_time matches 1260 run function airconditioner:games/pkn/round-advance
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 5..6 if score pkn AC_time matches 1860 run function airconditioner:games/pkn/round-advance
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 7 if score pkn AC_time matches 3660 run function airconditioner:games/pkn/round-advance
...
execute if score pkn AC_running matches 1 as @a[gamemode=adventure,tag=InGame] run function airconditioner:games/pkn/pattern-credit

execute if score pkn AC_running matches 1 if score pkn2 AC_functions matches 1 run function airconditioner:games/pkn/finish-check
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 8 if score pkn AC_time matches 1..3600 run function airconditioner:games/pkn/music
...
execute if score pkn AC_running matches 1 run function airconditioner:games/pkn/display

execute if score pkn AC_running matches 1 run effect give @a invisibility 1 1 true

execute if score pkn AC_running matches 1 if score pkn1 AC_functions matches 1 if score InGame AC_playercount matches 1 run function airconditioner:games/pkn/end
execute if score pkn AC_running matches 1 if score pkn1 AC_functions matches 1 if score pkn AC_time matches 0 if score round AC_pknScores matches 8 run function airconditioner:games/pkn/end

execute if score pkn AC_running matches 1 as @a[tag=InGame] at @s[gamemode=adventure] if score @s AC_CurrentY matches ..40 run function airconditioner:games/pkn/back-to-checkpoint
execute if score pkn AC_running matches 1 if score pkn1 AC_functions matches 1 run function airconditioner:games/pkn/checkpoints
...
execute if score pkn AC_running matches 1 if score pkn1 AC_functions matches 1 as @a[tag=InGame,gamemode=adventure,scores={AC_pknHealth=..0},tag=!pknEliminated] unless score @s AC_LeftGame matches 1.. if entity @s run function airconditioner:games/pkn/eliminate
...
execute if score pkn AC_running matches 1 if score pkn AC_time matches -1060 run function airconditioner:base/remove-spawn-tags
...
execute if score pkn AC_running matches 1 if score pkn AC_time matches -1060 run function airconditioner:auto/invoke
