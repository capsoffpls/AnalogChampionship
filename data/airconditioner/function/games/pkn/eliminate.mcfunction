...
execute if score @s AC_overtimePersonal matches 1.. run function airconditioner:base/overtime-personal-end

scoreboard players add @a[gamemode=adventure,tag=InGame] AC_sillyPointsHeld 10
