...
execute if score bsp AC_running matches 1 if score bsp1 AC_functions matches 1 run execute as @a[scores={AC_bspDeath=1..},gamemode=adventure] run scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 5
...
execute if score bsp AC_running matches 1 if score bsp1 AC_functions matches 1 run function airconditioner:games/bsp/wind_charge_timer
...
execute if score bsp AC_running matches 1 if score bsp1 AC_functions matches 1 run execute if score InGame AC_playercount matches 1 run scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 15
...
execute if score bsp AC_running matches 1 if score bsp1 AC_functions matches 1 run execute if score bsp AC_time matches 0 run scoreboard players add @a[tag=InGame,gamemode=adventure] AC_sillyPointsHeld 10
...
execute if score bsp AC_running matches 1 if score bsp AC_time matches -1 run function airconditioner:base/endsound
...
execute if score bsp AC_running matches 1 if score bsp AC_time matches -61 run function airconditioner:auto/invoke
