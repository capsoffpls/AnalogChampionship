...
execute unless block ~ ~ ~ air run return run function airconditioner:auto/playervote/check-block
execute if block ~ ~ ~ air positioned ^ ^ ^.05 run function airconditioner:auto/playervote/raycast