...
execute if score action AC_autoControl matches 1 run function airconditioner:auto/setup/next-round
...
execute if score action AC_autoControl matches 2..3 if score page AC_autoControl matches 1..4 run function airconditioner:auto/setup/next-page
...
execute if score action AC_autoControl matches 4 if score page AC_autoControl matches 1..3 run function airconditioner:auto/setup/next-page

$execute if score action AC_autoControl matches 5 run scoreboard players set x$(page) AC_autoControl $(round)
execute if score action AC_autoControl matches 5 if score page AC_autoControl matches 2..5 run function airconditioner:auto/setup/next-page