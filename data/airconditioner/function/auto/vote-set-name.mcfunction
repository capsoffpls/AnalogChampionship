$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-1 AC_autoControl matches -1 run function airconditioner:auto/roll-s {game:$(game),type:player,choose:1}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-1 AC_autoControl matches -2 run function airconditioner:auto/roll-m {game:$(game),type:player,choose:1}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-1 AC_autoControl matches -3 run function airconditioner:auto/roll-l {game:$(game),type:player,choose:1}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-1 AC_autoControl matches -4 run function airconditioner:auto/roll-xl {game:$(game),type:player,choose:1}

$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-2 AC_autoControl matches -1 run function airconditioner:auto/roll-s {game:$(game),type:player,choose:2}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-2 AC_autoControl matches -2 run function airconditioner:auto/roll-m {game:$(game),type:player,choose:2}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-2 AC_autoControl matches -3 run function airconditioner:auto/roll-l {game:$(game),type:player,choose:2}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-2 AC_autoControl matches -4 run function airconditioner:auto/roll-xl {game:$(game),type:player,choose:2}

$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-3 AC_autoControl matches -1 run function airconditioner:auto/roll-s {game:$(game),type:player,choose:3}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-3 AC_autoControl matches -2 run function airconditioner:auto/roll-m {game:$(game),type:player,choose:3}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-3 AC_autoControl matches -3 run function airconditioner:auto/roll-l {game:$(game),type:player,choose:3}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-3 AC_autoControl matches -4 run function airconditioner:auto/roll-xl {game:$(game),type:player,choose:3}

$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-4 AC_autoControl matches -1 run function airconditioner:auto/roll-s {game:$(game),type:player,choose:4}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-4 AC_autoControl matches -2 run function airconditioner:auto/roll-m {game:$(game),type:player,choose:4}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-4 AC_autoControl matches -3 run function airconditioner:auto/roll-l {game:$(game),type:player,choose:4}
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-4 AC_autoControl matches -4 run function airconditioner:auto/roll-xl {game:$(game),type:player,choose:4}


$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-1 AC_autoControl matches -1 run function airconditioner:auto/roll-s {game:$(game),type:public,choose:1}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-1 AC_autoControl matches -2 run function airconditioner:auto/roll-m {game:$(game),type:public,choose:1}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-1 AC_autoControl matches -3 run function airconditioner:auto/roll-l {game:$(game),type:public,choose:1}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-1 AC_autoControl matches -4 run function airconditioner:auto/roll-xl {game:$(game),type:public,choose:1}

$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-2 AC_autoControl matches -1 run function airconditioner:auto/roll-s {game:$(game),type:public,choose:2}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-2 AC_autoControl matches -2 run function airconditioner:auto/roll-m {game:$(game),type:public,choose:2}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-2 AC_autoControl matches -3 run function airconditioner:auto/roll-l {game:$(game),type:public,choose:2}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-2 AC_autoControl matches -4 run function airconditioner:auto/roll-xl {game:$(game),type:public,choose:2}

$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-3 AC_autoControl matches -1 run function airconditioner:auto/roll-s {game:$(game),type:public,choose:3}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-3 AC_autoControl matches -2 run function airconditioner:auto/roll-m {game:$(game),type:public,choose:3}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-3 AC_autoControl matches -3 run function airconditioner:auto/roll-l {game:$(game),type:public,choose:3}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-3 AC_autoControl matches -4 run function airconditioner:auto/roll-xl {game:$(game),type:public,choose:3}

$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-4 AC_autoControl matches -1 run function airconditioner:auto/roll-s {game:$(game),type:public,choose:4}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-4 AC_autoControl matches -2 run function airconditioner:auto/roll-m {game:$(game),type:public,choose:4}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-4 AC_autoControl matches -3 run function airconditioner:auto/roll-l {game:$(game),type:public,choose:4}
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-4 AC_autoControl matches -4 run function airconditioner:auto/roll-xl {game:$(game),type:public,choose:4}
...
$execute if score game$(game) AC_autoControl matches -20..-10 if score lang AC_lang matches 0 run tellraw @a [{"text":"[AUTO] ","bold":true,"color":"gold"},{"text":"Tryby do wybrania w tym głosowaniu to:\n","color":"yellow","bold":false},{"text":">> ",bold:true,color:yellow},{interpret:true,"storage":"ac:auto.vote","nbt":"option1",bold:true,color:gold,click_event:{action:"run_command",command:"function airconditioner:auto/vote-choose {game:$(game),chosen:1}"}},{"text":"\n>> ",bold:true,color:yellow},{interpret:true,"storage":"ac:auto.vote","nbt":"option2",bold:true,color:gold,click_event:{action:"run_command",command:"function airconditioner:auto/vote-choose {game:$(game),chosen:2}"}},{"text":"\n>> ",bold:true,color:yellow},{interpret:true,"storage":"ac:auto.vote","nbt":"option3",bold:true,color:gold,click_event:{action:"run_command",command:"function airconditioner:auto/vote-choose {game:$(game),chosen:3}"}},{"text":"\n>> ",bold:true,color:yellow},{interpret:true,"storage":"ac:auto.vote","nbt":"option4",bold:true,color:gold,click_event:{action:"run_command",command:"function airconditioner:auto/vote-choose {game:$(game),chosen:4}"}}]
...
function airconditioner:auto/disable-gamemode with storage ac:auto