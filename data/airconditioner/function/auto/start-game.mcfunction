...
execute if score auto AC_running matches 1 if score wait AC_time matches 0 run function airconditioner:base/gm-start
execute if score wait AC_running matches 1 if score wait AC_time matches 0 run function airconditioner:base/empty-all-queues
