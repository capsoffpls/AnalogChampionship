...
execute if score auto AC_autoControl matches 1 if score round AC_autoControl matches 1.. run function airconditioner:base/timer-set1m
execute if score auto AC_autoControl matches 1 if score round AC_autoControl matches 0 unless score mode AC_autoControl matches 4 run function airconditioner:base/timer-set5m

execute as @a run function airconditioner:base/tpitems
function airconditioner:camera/return