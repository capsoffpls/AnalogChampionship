execute as @a[tag=!InDuel] if score @s AC_DuelQueue matches 1..16384 run function airconditioner:duels/start-duel-queue

function airconditioner:duels/update-duel-queue with storage ac:queue.duels.1
function airconditioner:duels/update-duel-queue with storage ac:queue.duels.2
function airconditioner:duels/update-duel-queue with storage ac:queue.duels.3

execute unless score Duel1 AC_QueuedCount matches 1..16384 run scoreboard players set duel_1 AC_QueuedCount 0
execute unless score Duel2 AC_QueuedCount matches 1..16384 run scoreboard players set duel_2 AC_QueuedCount 0
execute unless score Duel3 AC_QueuedCount matches 1..16384 run scoreboard players set duel_3 AC_QueuedCount 0

function airconditioner:duels/queue-bossbar {"queue":1}
function airconditioner:duels/queue-bossbar {"queue":2}
function airconditioner:duels/queue-bossbar {"queue":3}
...
execute unless score Duel1 AC_QueuedCount matches 1.. run data remove storage ac:queue.duels.1 mode
execute unless score Duel2 AC_QueuedCount matches 1.. run data remove storage ac:queue.duels.2 mode
execute unless score Duel3 AC_QueuedCount matches 1.. run data remove storage ac:queue.duels.3 mode
execute unless score Duel1 AC_QueuedCount matches 1.. run bossbar set ac_duel1 visible false
execute unless score Duel2 AC_QueuedCount matches 1.. run bossbar set ac_duel2 visible false
execute unless score Duel3 AC_QueuedCount matches 1.. run bossbar set ac_duel3 visible false
...
execute if score duel_1 AC_QueuedCount matches 2 run function airconditioner:duels/init
execute if score duel_2 AC_QueuedCount matches 2 run function airconditioner:duels/init
execute if score duel_3 AC_QueuedCount matches 2 run function airconditioner:duels/init