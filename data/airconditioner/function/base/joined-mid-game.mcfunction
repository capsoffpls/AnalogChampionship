...
execute if score quit-detection AC_misc matches 1 if entity @s[tag=InGame] unless score @s AC_CurrentlyPlayed = NowPlaying AC_CurrentlyPlayed run function airconditioner:base/quit-detected
