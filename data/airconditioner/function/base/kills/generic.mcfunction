...
execute as @a[scores={AC_killmessage=1..}] run function airconditioner:base/kills/_message
execute as @a[scores={AC_deathmessage=1..}] unless entity @a[scores={AC_killmessage=1..}] run function airconditioner:base/deathmessage with storage ac:death