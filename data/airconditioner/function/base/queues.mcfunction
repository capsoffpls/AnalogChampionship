execute as @a[scores={AC_LeftGame=1..},tag=!practice] run function airconditioner:base/queue-items

execute as @a[tag=!InQueue] if score @s AC_Queue matches -1000..-1 run function airconditioner:base/start-queue
execute as @a[tag=!InQueue] if score @s AC_Queue matches 1..1000 run function airconditioner:base/start-queue

function airconditioner:base/update-queue with storage ac:queue.1
function airconditioner:base/update-queue with storage ac:queue.2
function airconditioner:base/update-queue with storage ac:queue.3
...
function airconditioner:base/queue-bossbar {"queue":1}
function airconditioner:base/queue-bossbar {"queue":2}
function airconditioner:base/queue-bossbar {"queue":3}
...
execute if score queued_1 AC_QueuedCount matches ..3 run function airconditioner:base/reset-queue1
execute if score queued_2 AC_QueuedCount matches ..3 run function airconditioner:base/reset-queue2
execute if score queued_3 AC_QueuedCount matches ..3 run function airconditioner:base/reset-queue3
execute unless score wait AC_running matches 1 if score wait AC_time matches 0 if score queued_1 AC_QueuedCount matches 4.. unless score queued_2 AC_QueuedCount matches 4.. unless score queued_3 AC_QueuedCount matches 4.. unless score duel AC_running matches 1 run function airconditioner:base/start-from-queue {"queue":1}
execute unless score wait AC_running matches 1 if score wait AC_time matches 0 unless score queued_1 AC_QueuedCount matches 4.. if score queued_2 AC_QueuedCount matches 4.. unless score queued_3 AC_QueuedCount matches 4.. unless score duel AC_running matches 1 run function airconditioner:base/start-from-queue {"queue":2}
execute unless score wait AC_running matches 1 if score wait AC_time matches 0 unless score queued_1 AC_QueuedCount matches 4.. unless score queued_2 AC_QueuedCount matches 4.. if score queued_3 AC_QueuedCount matches 4.. unless score duel AC_running matches 1 run function airconditioner:base/start-from-queue {"queue":3}
...
execute if score wait AC_running matches 1 if score wait AC_time matches 60 run function airconditioner:base/queue-prepare