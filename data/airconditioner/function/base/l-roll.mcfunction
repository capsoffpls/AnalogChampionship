...
execute if score draw-l AC_misc matches 60 run function airconditioner:base/l-correct

execute if score draw-l AC_misc matches 1..61 run function airconditioner:base/l-set

execute if score draw-l AC_misc matches 61 run function airconditioner:base/gm-announce
