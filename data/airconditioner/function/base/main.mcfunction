...
function airconditioner:duels/main

function airconditioner:base/bubbles-and-bombs
execute as @a[scores={AC_overtimePersonal=1..}] run function airconditioner:base/overtime-personal

execute as @a unless score @s AC_QueueSort matches 1..2 run scoreboard players set @s AC_QueueSort 1

execute if score queues AC_misc matches 1 if score NowPlaying AC_CurrentlyPlayed matches 0 run function airconditioner:base/queues
execute if score combatlog AC_misc matches 1 run function airconditioner:base/combatlog-main

execute if score auto AC_autoControl matches 1 run function airconditioner:auto/main
execute if score auto AC_autoControl matches 1 run function airconditioner:auto/vote-island

execute if score status AC_hasBanned matches 1 run execute as @a run function airconditioner:base/gm-bandetect
...
execute if score NowPlaying AC_CurrentlyPlayed matches 0 if score scoreboard-carousel AC_misc matches 30.. if score scoreboard-shown AC_misc matches 1 run scoreboard objectives setdisplay sidebar AC_sillyPoints
execute if score NowPlaying AC_CurrentlyPlayed matches 0 if score scoreboard-carousel AC_misc matches 30.. if score scoreboard-shown AC_misc matches 2 run scoreboard objectives setdisplay sidebar AC_sillyPointsRanked
...
execute if block 2 49 -6 mangrove_button[powered=true] run function airconditioner:base/gm-infoboard-minus
...
execute if block 2 49 -3 mangrove_button[powered=true] run function airconditioner:base/gm-infoboard-plus
...
execute as @a[scores={AC_lobbyTeleporters=1..}] if items entity @s weapon.* carrot_on_a_stick[item_model="ac:play_admin",custom_data={chuj:1}] run function airconditioner:menu/start
execute as @a[scores={AC_lobbyTeleporters=1..}] if items entity @s weapon.* carrot_on_a_stick[item_model="ac:pvpzone",custom_data~{chuj:-1}] run function airconditioner:menu/duel
execute as @a[scores={AC_lobbyTeleporters=1..}] if items entity @s weapon.* carrot_on_a_stick[item_model="ac:play",custom_data~{chuj:-1}] run function airconditioner:menu/queue-up
execute as @a[scores={AC_lobbyTeleporters=1..}] if items entity @s weapon.* carrot_on_a_stick[item_model="ac:cancel",custom_data~{chuj:-1}] run function airconditioner:menu/leave-queue

execute if score auto AC_autoControl matches 1 run execute as @a[scores={AC_lobbyTeleporters=1..}] if items entity @s weapon.* carrot_on_a_stick[item_model="ac:arrow_up",custom_data={chuj:1}] run execute at @s anchored eyes run function airconditioner:auto/playervote/raycast
...
execute as @a[scores={AC_LeftGame=1..}] if score NowPlaying AC_CurrentlyPlayed matches 1.. unless score GameID AC_CurrentGameID = @s AC_CurrentGameID run function airconditioner:base/joined-mid-game
execute if score quit-detection AC_misc matches 1 as @a[tag=InGame,scores={AC_LeftGame=1..}] if score @s AC_CurrentlyPlayed matches 1.. if score NowPlaying AC_CurrentlyPlayed matches 0 run function airconditioner:base/quit-detected
execute if score combatlog AC_misc matches 1 if entity @s[tag=InGame,scores={AC_LeftGame=1..,AC_combatlog=1..}] run function airconditioner:base/combatlog-detected
...
execute as @a[scores={AC_LeftGame=1..}] if score @s AC_CurrentlyPlayed matches 1.. if score NowPlaying AC_CurrentlyPlayed matches 0 run function airconditioner:menu/give-roles
execute as @a[scores={AC_LeftGame=1..}] if score @s AC_CurrentlyPlayed matches 1.. if score NowPlaying AC_CurrentlyPlayed matches 0 run function airconditioner:base/tpitems
