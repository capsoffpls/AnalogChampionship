...
#execute unless score ranked AC_misc matches 1 if score draw AC_misc matches 60 run function airconditioner:base/gm-correct
execute if score isRanked AC_CurrentlyPlayed matches 0 if score draw AC_misc matches 60 run function airconditioner:base/gm-correct
#execute if score isRanked AC_CurrentlyPlayed matches 1 if score draw AC_misc matches 60 run function airconditioner:base/ranked-correct
execute if score draw AC_misc matches 1..61 run function airconditioner:base/gm-set

execute if score draw AC_misc matches 61 run function airconditioner:base/gm-announce
