...
execute if score draw-m AC_misc matches 60 run function airconditioner:base/m-correct

execute if score draw-m AC_misc matches 1..61 run function airconditioner:base/m-set

execute if score draw-m AC_misc matches 61 run function airconditioner:base/gm-announce
