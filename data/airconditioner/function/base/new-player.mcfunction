...
execute unless score NowPlaying AC_CurrentlyPlayed matches 0 run function airconditioner:base/joined-mid-game
function airconditioner:menu/give-roles
function airconditioner:base/tpitems
