...
$execute if score $(mode) AC_banprotected matches 1 run dialog show @s airconditioner:tournament-protected
...
$execute unless score $(mode) AC_banprotected matches 1 run dialog show @s airconditioner:tournament-$(next_page)