...
execute if score draw-xl AC_misc matches 60 run function airconditioner:base/xl-correct

execute if score draw-xl AC_misc matches 1..61 run function airconditioner:base/xl-set

execute if score draw-xl AC_misc matches 61 run function airconditioner:base/gm-announce
