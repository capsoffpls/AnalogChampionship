...
execute if score draw-s AC_misc matches 60 run function airconditioner:base/s-correct

execute if score draw-s AC_misc matches 1..61 run function airconditioner:base/s-set

execute if score draw-s AC_misc matches 61 run function airconditioner:base/gm-announce
