...
#   run item replace entity @s hotbar.0 with stone_sword[unbreakable={},custom_data={ac:pvpzone,chuj:3},weapon={disable_blocking_for_seconds:1}] 1
    ...
    run function airconditioner:base/queue-items
...
execute as @a[tag=pvpZone] unless entity @s[x=74,y=44,z=-27,dx=41,dy=19,dz=55] run function airconditioner:menu/give-roles
execute as @a[tag=pvpZone] unless entity @s[x=74,y=44,z=-27,dx=41,dy=19,dz=55] run spawnpoint @s 0 50 0 0 0
execute as @a[tag=pvpZone] unless entity @s[x=74,y=44,z=-27,dx=41,dy=19,dz=55] run function airconditioner:base/tpitems
