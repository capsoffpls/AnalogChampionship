...
function airconditioner:base/lobby/practice/pkn/leaderboard-test-for-better-score with storage ac:pkn_practice loaded

execute if score compare_record_sec AC_practicePKNOptions matches 0 if score compare_record_ms AC_practicePKNOptions matches 0 if score better_score_check AC_practicePKNOptions matches 0 run return run function airconditioner:base/lobby/practice/pkn/leaderboard-new-entry with storage ac:pkn_practice loaded
...
execute if score @s AC_practicePKNSeconds < compare_record_sec AC_practicePKNOptions if score better_score_check AC_practicePKNOptions matches 0 run return run function airconditioner:base/lobby/practice/pkn/leaderboard-new-entry with storage ac:pkn_practice loaded
