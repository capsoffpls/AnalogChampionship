execute as @a[x=-121,y=20,z=16,dx=17,dy=18,dz=37,gamemode=adventure] unless entity @s[tag=practicePKN] run function airconditioner:base/lobby/practice/pkn/start
...
execute as @a[tag=practicePKN] run function airconditioner:base/lobby/practice/pkn/lag-check
...
execute as @a[tag=practicePKN] if entity @s[x=-114,y=27,z=53,dx=2,dy=2,dz=1,gamemode=adventure] unless score @s AC_practicePKNSeconds matches ..1 run function airconditioner:base/lobby/practice/pkn/leaderboard-check with storage ac:pkn_practice loaded
execute as @a[tag=practicePKN] if entity @s[x=-114,y=27,z=53,dx=2,dy=2,dz=1,gamemode=adventure] run function airconditioner:base/lobby/practice/pause
execute as @a[tag=practicePKN] unless entity @s[x=-121,y=20,z=16,dx=17,dy=18,dz=37,gamemode=adventure] run function airconditioner:base/lobby/practice/pause