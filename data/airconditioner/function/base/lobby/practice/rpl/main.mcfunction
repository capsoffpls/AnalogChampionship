...
execute as @a[tag=practiceRPL] if entity @s[advancements={ac:rpl.blockplacement=true}] run function airconditioner:base/lobby/practice/rpl/check
execute if score rpl AC_time matches ..0 run function airconditioner:base/lobby/practice/rpl/new-canvas
