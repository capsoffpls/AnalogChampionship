...
execute as @a[tag=lobbyParkour] if score queues AC_misc matches 1 run function airconditioner:base/queue-items
...
execute as @a if entity @s[x=-17,y=58,z=98,dy=1,tag=lobbyParkour] run function airconditioner:base/tpitems
