...
execute unless score 37 AC_gamemode matches 0 if score xl AC_gamemode matches 6 run scoreboard players add xl AC_gamemode 1
execute unless score 46 AC_gamemode matches 0 if score xl AC_gamemode matches 7 run scoreboard players set xl AC_gamemode 1
...
execute unless score 25 AC_gamemode matches 0 if score xl AC_gamemode matches 5 run scoreboard players add xl AC_gamemode 1
execute unless score 37 AC_gamemode matches 0 if score xl AC_gamemode matches 6 run scoreboard players add xl AC_gamemode 1
execute unless score 46 AC_gamemode matches 0 if score xl AC_gamemode matches 7 run function ac:base/xl-correct
...
execute if score xl AC_gamemode matches 7 run scoreboard players set gm AC_gamemode 46
