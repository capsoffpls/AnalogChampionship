...
execute if score pop AC_running matches 1 if score pop1 AC_functions matches 1 run function ac:pop/pop-spawn
execute if score pop AC_running matches 1 if score pop1 AC_functions matches 1 run function ac:pop/trail
