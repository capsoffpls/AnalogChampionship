...
execute if score pct AC_running matches 1 if score pct AC_time matches 18200 run function ac:pct/prepare
...
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score knights-m AC_pctInPoint matches 2.. run function ac:pct/takeover/none-kl

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kl AC_pctInPoint matches 0 if score knights-kl AC_pctInPoint matches 0 run function ac:pct/takeover/none-kl
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-l AC_pctInPoint matches 0 if score knights-l AC_pctInPoint matches 0 run function ac:pct/takeover/none-l
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 0 if score knights-m AC_pctInPoint matches 0 run function ac:pct/takeover/none-m
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-r AC_pctInPoint matches 0 if score knights-r AC_pctInPoint matches 0 run function ac:pct/takeover/none-r
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kr AC_pctInPoint matches 0 if score knights-kr AC_pctInPoint matches 0 run function ac:pct/takeover/none-kr

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 2.. run function ac:pct/takeover/none-kr

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kl AC_pctInPoint matches 1.. if score knights-kl AC_pctInPoint matches 1.. run function ac:pct/takeover/both-kl
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-l AC_pctInPoint matches 1.. if score knights-l AC_pctInPoint matches 1.. run function ac:pct/takeover/both-l
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 1.. if score knights-m AC_pctInPoint matches 1.. run function ac:pct/takeover/both-m
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-r AC_pctInPoint matches 1.. if score knights-r AC_pctInPoint matches 1.. run function ac:pct/takeover/both-r
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kr AC_pctInPoint matches 1.. if score knights-kr AC_pctInPoint matches 1.. run function ac:pct/takeover/both-kr

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-l AC_pctInPoint matches 1.. if score knights-l AC_pctInPoint matches 0 run function ac:pct/takeover/hussars-l
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 1.. if score knights-m AC_pctInPoint matches 0 run function ac:pct/takeover/hussars-m
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-r AC_pctInPoint matches 1.. if score knights-r AC_pctInPoint matches 0 run function ac:pct/takeover/hussars-r
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kr AC_pctInPoint matches 1.. if score knights-kr AC_pctInPoint matches 0 if score knights-m AC_pctInPoint matches 0..1 run function ac:pct/takeover/hussars-kr

execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-kl AC_pctInPoint matches 0 if score knights-kl AC_pctInPoint matches 1.. if score hussars-m AC_pctInPoint matches 0..1 run function ac:pct/takeover/knights-kl
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-l AC_pctInPoint matches 0 if score knights-l AC_pctInPoint matches 1.. run function ac:pct/takeover/knights-l
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-m AC_pctInPoint matches 0 if score knights-m AC_pctInPoint matches 1.. run function ac:pct/takeover/knights-m
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run execute if score hussars-r AC_pctInPoint matches 0 if score knights-r AC_pctInPoint matches 1.. run function ac:pct/takeover/knights-r
...
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run function ac:pct/passive-points
execute if score pct AC_running matches 1 if score pct1 AC_functions matches 1 run function ac:pct/actionbar
...
execute if score pct AC_running matches 1 if score pct2 AC_functions matches 1 run function ac:pct/death-cooldown
