execute if score omc AC_running matches 1 if score omc AC_time matches -60 run function ac:omc/round-prepare
...
execute if score omc AC_running matches 1 if score omc AC_time matches 1200 unless score modifier AC_omcRNG matches 30 run execute if score round AC_omcRound matches 2..5 run function ac:omc/rng/modifier
...
execute as @a[tag=!omcDead,x=497,y=50,z=-1003,dx=6,dz=6,dy=6] if score tick AC_omc matches 5 run function ac:omc/exchange/brick
execute as @a[tag=!omcDead,x=497,y=50,z=-1003,dx=6,dz=6,dy=6] if score tick AC_omc matches 5 run function ac:omc/exchange/iron
execute as @a[tag=!omcDead,x=497,y=50,z=-1003,dx=6,dz=6,dy=6] if score tick AC_omc matches 5 run function ac:omc/exchange/copper
