...
execute if score 1st AC_ttrScores matches 1 if score 2nd AC_ttrScores matches 1 if score 3rd AC_ttrScores matches 1 run function ac:ttr/reward
...
execute if score 1st AC_ttrScores matches 1 if score 2nd AC_ttrScores matches 1 if score 3rd AC_ttrScores matches 0 run function ac:ttr/reward
...
execute if score 1st AC_ttrScores matches 1 if score 2nd AC_ttrScores matches 0 run function ac:ttr/reward
...
execute if score 1st AC_ttrScores matches 0 run function ac:ttr/reward
