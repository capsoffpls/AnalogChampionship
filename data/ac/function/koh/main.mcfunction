...
execute if score koh AC_running matches 1 run execute if score koh AC_time matches 1800 run function ac:koh/start
...
execute if score koh AC_running matches 1 if score koh1 AC_functions matches 1 if score second AC_misc matches 15 run execute as @a[tag=InGame,gamemode=adventure] at @s if block ~ ~-1 ~ red_concrete run function ac:koh/award

execute if score koh AC_running matches 1 run execute if score koh AC_time matches 0 run function ac:koh/end
