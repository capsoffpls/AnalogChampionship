...
execute as @e[type=item_display,tag=bonus,tag=!collected] at @s run execute as @e[type=horse,dy=1,limit=1] on passengers if score @s AC_hknVelocity matches 350 run function ac:hkn/bonus-activate
