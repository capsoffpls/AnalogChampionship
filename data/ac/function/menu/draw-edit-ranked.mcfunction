$scoreboard players add ranked$(mode) AC_gamemode 1
$execute if score ranked$(mode) AC_gamemode matches 1.. run scoreboard players set ranked$(mode) AC_gamemode -1
...
$execute if score $(mode) AC_gamemode matches -1 if score draw-edit AC_misc matches 1 if score lang AC_lang matches 0 run tellraw @a [{"text":"[AC] ","bold":true,"color":"white"},{"text":"Tryb ","color":"gray","bold":false},{interpret:true,"storage":"ac_modes","nbt":"draw.last_edit","bold":true,"color":"white"},{"text":" został wykluczony z losowania rankingowego.","color":"gray","bold":false}]
$execute if score $(mode) AC_gamemode matches -1 if score draw-edit AC_misc matches 1 if score lang AC_lang matches 1 run tellraw @a [{"text":"[AC] ","bold":true,"color":"white"},{interpret:true,"storage":"ac_modes","nbt":"draw.last_edit","bold":true,"color":"white"},{"text":" has been excluded from ranked play.","color":"gray","bold":false}]
$execute if score $(mode) AC_gamemode matches 0 if score draw-edit AC_misc matches 1 if score lang AC_lang matches 0 run tellraw @a [{"text":"[AC] ","bold":true,"color":"white"},{"text":"Tryb ","color":"gray","bold":false},{interpret:true,"storage":"ac_modes","nbt":"draw.last_edit","bold":true,"color":"white"},{"text":" został włączony do losowania rankingowego.","color":"gray","bold":false}]
$execute if score $(mode) AC_gamemode matches 0 if score draw-edit AC_misc matches 1 if score lang AC_lang matches 1 run tellraw @a [{"text":"[AC] ","bold":true,"color":"white"},{interpret:true,"storage":"ac_modes","nbt":"draw.last_edit","bold":true,"color":"white"},{"text":" has been included into ranked play.","color":"gray","bold":false}]
