...
execute if score trl AC_running matches 1 if score trl1 AC_functions matches 1 run execute if score timer AC_trlTimer matches -59..30 as @a[tag=InGame,gamemode=adventure] run function ac:trl/save
execute if score trl AC_running matches 1 if score trl1 AC_functions matches 1 run execute if score timer AC_trlTimer matches -59..0 run function ac:trl/movement-check
execute if score trl AC_running matches 1 if score trl1 AC_functions matches 1 run execute as @e[x=99,y=54,z=-2016,dz=32,dx=1,dy=2,gamemode=adventure] run function ac:trl/reward
execute if score trl AC_running matches 1 if score trl1 AC_functions matches 1 run function ac:trl/cycle
