...
execute if score asp AC_running matches 1 if score asp1 AC_functions matches 1 run function ac:asp/anti-afk
execute if score asp AC_running matches 1 if score asp1 AC_functions matches 1 run function ac:asp/spawn
...
execute if score asp AC_running matches 1 if score asp1 AC_functions matches 1 run execute as @a[gamemode=adventure,scores={AC_aspDeath=1..}] if entity @s run function ac:asp/death
...
execute if score asp AC_running matches 1 if score asp AC_time matches ..0 run execute if score InGame AC_playercount matches 1 run function ac:asp/end-winner
execute if score asp AC_running matches 1 if score asp AC_time matches ..0 run execute if score InGame AC_playercount matches 0 run function ac:asp/end-nowinner
