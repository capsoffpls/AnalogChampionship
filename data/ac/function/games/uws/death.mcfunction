...
execute if score InGame AC_playercount matches 2 run function ac:games/uws/end-winner
execute if score InGame AC_playercount matches 1 run function ac:games/uws/end-draw