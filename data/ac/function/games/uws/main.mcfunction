...
execute if score uws AC_running matches 1 if score uws AC_time matches 1..6000 as @a[advancements={ac:uws_hitdetect=true}] if score @s AC_uwsAttackTimer matches 0 run function ac:games/uws/reward
...
execute if score uws AC_running matches 1 if score uws AC_time matches 1..6000 run execute as @a[scores={AC_deathmessage=1..},gamemode=adventure] if entity @s run function ac:games/uws/death

execute if score uws AC_running matches 1 if score uws AC_time matches 0 run function ac:games/uws/end-timeout
