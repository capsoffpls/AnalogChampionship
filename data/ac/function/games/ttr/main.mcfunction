...
############### ring
execute as @e[type=marker,tag=ttrMarker] at @s run function ac:games/ttr/ring-loop
execute as @a[gamemode=spectator] run function ac:games/ttr/ring-draw
...
execute if score ttr AC_time matches 0..1800 as @a[tag=InGame,gamemode=adventure] run function ac:games/ttr/velocity
...
execute if score ttr AC_time matches -1 run function ac:base/remove-spawn-tags
