execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run function ac:games/bwr/bossbar
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute as @a[scores={AC_bwrWoolDetection=1..}] at @s run function ac:games/bwr/blocktimer
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 8400 as @a[tag=InGame,gamemode=adventure] run function ac:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 7200 as @a[tag=InGame,gamemode=adventure] run function ac:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 6000 as @a[tag=InGame,gamemode=adventure] run function ac:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 4800 as @a[tag=InGame,gamemode=adventure] run function ac:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 3600 as @a[tag=InGame,gamemode=adventure] run function ac:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 2400 as @a[tag=InGame,gamemode=adventure] run function ac:games/bwr/reward-60s
...
execute if score bwr AC_running matches 1 if score bwr2 AC_functions matches 1 run execute if score bwr AC_time matches 1200 as @a[tag=InGame,gamemode=adventure] run function ac:games/bwr/reward-60s
...
#execute if score bwr AC_running matches 1 if score bwr1 AC_functions matches 1 run execute as @a[advancements={ac:bwr_melee=true}] run function ac:games/bwr/anti-melee
...
execute if score bwr AC_running matches 1 if score bwr AC_time matches -1 run function ac:games/bwr/blockclear
