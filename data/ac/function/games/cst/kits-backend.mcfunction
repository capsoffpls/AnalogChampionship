...
execute as @e[tag=cstClass1] on target unless entity @s[tag=cstLockedIn] run function ac:games/cst/classes/warrior
execute as @e[tag=cstClass2] on target unless entity @s[tag=cstLockedIn] run function ac:games/cst/classes/assassin
execute as @e[tag=cstClass3] on target unless entity @s[tag=cstLockedIn] run function ac:games/cst/classes/scout
execute as @e[tag=cstClass4] on target unless entity @s[tag=cstLockedIn] run function ac:games/cst/classes/sniper

execute as @e[tag=cstClass5] on target unless entity @s[tag=cstLockedIn] run function ac:games/cst/classes/rebel
execute as @e[tag=cstClass6] on target unless entity @s[tag=cstLockedIn] run function ac:games/cst/classes/arsonist

execute as @e[tag=cstClass7] on target unless entity @s[tag=cstLockedIn] run function ac:games/cst/classes/tank
execute as @e[tag=cstClass8] on target unless entity @s[tag=cstLockedIn] run function ac:games/cst/classes/shooter
