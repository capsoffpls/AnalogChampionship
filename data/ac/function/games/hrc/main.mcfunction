execute if score hrc AC_running matches 1 if score hrc AC_time matches 6200 run function ac:games/hrc/prepare
...
execute if score hrc AC_running matches 1 if score hrc1 AC_functions matches 1 run function ac:games/hrc/ride
...
execute if score hrc AC_running matches 1 if score hrc1 AC_functions matches 1 run function ac:games/hrc/bonus
execute if score hrc AC_running matches 1 if score hrc1 AC_functions matches 1 run function ac:games/hrc/velocity-decay
...
execute if score hrc AC_running matches 1 if score hrc1 AC_functions matches 1 run function ac:games/hrc/calc-diff
...
execute if score hrc AC_running matches 1 if score hrc AC_time matches 1..6000 run function ac:games/hrc/checkpoints
...
execute if score hrc AC_running matches 1 if score hrc AC_time matches -1 run function ac:base/remove-spawn-tags
