execute if score ctf AC_running matches 1 if score ctf AC_time matches 24036 run function ac:games/ctf/prepare
...
execute if score ctf AC_running matches 1 if score ctf AC_time matches 0 run function ac:games/ctf/deathmatch-start
...
execute if score ctf AC_running matches 1 run execute as @a[tag=InGame] if entity @s[tag=!ctfBuildLimit,advancements={ac:ctf_buildlimit=true}] run function ac:games/ctf/warn-buildlimit
...
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function ac:games/ctf/death-cooldown
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function ac:games/ctf/playerdies
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function ac:games/ctf/spawnprot
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function ac:games/ctf/special-items
...
execute if score ctf AC_running matches 1 if score ctf3 AC_functions matches 1 run function ac:games/ctf/own-flag-room
execute if score ctf AC_running matches 1 if score ctf3 AC_functions matches 1 run function ac:games/ctf/conquering
...
#execute if score ctf AC_running matches 1 if score ctf3 AC_functions matches 1 if score ctf AC_chosenMap matches 1 run function #ac:ctf-map1flags
execute if score ctf AC_running matches 1 if score ctf3 AC_functions matches 1 run function ac:games/ctf/team-status