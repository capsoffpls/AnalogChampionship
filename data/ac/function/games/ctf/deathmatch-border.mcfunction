...
execute if score timer AC_ctfDeathmatch matches 50.. at @e[type=marker,tag=border-center] run function ac:games/ctf/deathmatch-destroy with storage ac:ctf.borderdestroy
