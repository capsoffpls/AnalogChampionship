...
execute if score round AC_jgtScores matches 1 as @a[tag=spawn1] run function ac:games/jgt/make-juggernaut
...
execute if score round AC_jgtScores matches 2 as @a[tag=spawn2] run function ac:games/jgt/make-juggernaut
