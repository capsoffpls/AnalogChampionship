...
execute if score @s AC_bedArmor matches 2 if score @s AC_bedEmerald matches 6.. run function ac:games/bed/shopping-items/diamond_armor
...
execute if score @s AC_bedArmor matches 1 if score @s AC_bedGold matches 12.. run function ac:games/bed/shopping-items/iron_armor
...
execute if score @s AC_bedArmor matches 0 if score @s AC_bedIron matches 30.. run function ac:games/bed/shopping-items/chain_armor
