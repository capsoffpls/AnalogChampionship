...
execute if entity @s[tag=Haste1] unless entity @s[tag=Haste2] if score @s AC_bedDiamond matches 6.. run execute as @s[team=ac_bedRed] if entity @s run function ac:games/bed/shopping-items/team_haste2
execute if entity @s[tag=Haste1] unless entity @s[tag=Haste2] if score @s AC_bedDiamond matches 6.. run execute as @s[team=ac_bedYellow] if entity @s run function ac:games/bed/shopping-items/team_haste2
execute if entity @s[tag=Haste1] unless entity @s[tag=Haste2] if score @s AC_bedDiamond matches 6.. run execute as @s[team=ac_bedGreen] if entity @s run function ac:games/bed/shopping-items/team_haste2
execute if entity @s[tag=Haste1] unless entity @s[tag=Haste2] if score @s AC_bedDiamond matches 6.. run execute as @s[team=ac_bedBlue] if entity @s run function ac:games/bed/shopping-items/team_haste2
...
execute unless entity @s[tag=Haste1] unless entity @s[tag=Haste2] if score @s AC_bedDiamond matches 4.. run execute as @s[team=ac_bedRed] if entity @s run function ac:games/bed/shopping-items/team_haste1
execute unless entity @s[tag=Haste1] unless entity @s[tag=Haste2] if score @s AC_bedDiamond matches 4.. run execute as @s[team=ac_bedYellow] if entity @s run function ac:games/bed/shopping-items/team_haste1
execute unless entity @s[tag=Haste1] unless entity @s[tag=Haste2] if score @s AC_bedDiamond matches 4.. run execute as @s[team=ac_bedGreen] if entity @s run function ac:games/bed/shopping-items/team_haste1
execute unless entity @s[tag=Haste1] unless entity @s[tag=Haste2] if score @s AC_bedDiamond matches 4.. run execute as @s[team=ac_bedBlue] if entity @s run function ac:games/bed/shopping-items/team_haste1
