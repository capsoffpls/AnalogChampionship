...
execute if score ddb AC_running matches 1 if score ddb AC_time matches 2400 run function ac:games/ddb/spawnarrow-yellow
execute if score ddb AC_running matches 1 if score ddb AC_time matches 2400 run function ac:games/ddb/spawnarrow-blue
execute if score ddb AC_running matches 1 if score ddb AC_time matches 2400 run function ac:games/ddb/imparity-check
...
execute if score ddb AC_running matches 1 if score ddb1 AC_functions matches 1 run execute as @a[gamemode=spectator,team=ac_ddbYellow,tag=hasArrow] if entity @s run function ac:games/ddb/spawnarrow-yellow
...
execute if score ddb AC_running matches 1 if score ddb1 AC_functions matches 1 run execute as @a[gamemode=spectator,team=ac_ddbBlue,tag=hasArrow] if entity @s run function ac:games/ddb/spawnarrow-blue
...
execute if score ddb AC_running matches 1 if score ddb2 AC_functions matches 1 run execute as @a[scores={AC_deathmessage=1..},team=ac_ddbBlue] if entity @s run function ac:games/ddb/spawnarrow-blue
...
execute if score ddb AC_running matches 1 if score ddb2 AC_functions matches 1 run execute as @a[scores={AC_deathmessage=1..},team=ac_ddbYellow] if entity @s run function ac:games/ddb/spawnarrow-yellow
...
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if entity @e[type=arrow,x=14,y=47,z=-500,dz=17,dy=300] run function ac:games/ddb/spawnarrow-blue
...
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if entity @e[type=arrow,x=-14,y=47,z=-483,dz=-17,dx=28] run function ac:games/ddb/spawnarrow-blue
...
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if entity @e[type=arrow,x=-14,y=47,z=-500,dz=17,dy=300] run function ac:games/ddb/spawnarrow-blue
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run kill @e[type=arrow,x=-14,y=47,z=-500,dz=17,dy=300]
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if entity @e[type=arrow,x=-14,y=47,z=-483,dx=28,dy=300] run function ac:games/ddb/spawnarrow-blue
...
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if entity @e[type=arrow,x=-14,y=47,z=-517,dz=17,dx=28] run function ac:games/ddb/spawnarrow-yellow
...
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if entity @e[type=arrow,x=14,y=47,z=-517,dz=17,dy=300] run function ac:games/ddb/spawnarrow-yellow
...
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if entity @e[type=arrow,x=-14,y=47,z=-517,dz=17,dy=300] run function ac:games/ddb/spawnarrow-yellow
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run kill @e[type=arrow,x=-14,y=47,z=-517,dz=17,dy=300]
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if entity @e[type=arrow,x=-14,y=47,z=-517,dx=28,dy=300] run function ac:games/ddb/spawnarrow-yellow
...
execute if score ddb AC_running matches 1 if score ddb3 AC_functions matches 1 run execute if score buffer AC_ddbSize matches 6.. unless score size AC_ddbSize matches 11.. run function ac:games/ddb/shrink
