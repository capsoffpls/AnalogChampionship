...
execute if score round AC_pktScores matches 1 run function ac:games/pkt/assign-roles
execute if score round AC_pktScores matches 3 run function ac:games/pkt/assign-roles
execute if score round AC_pktScores matches 5 run function ac:games/pkt/assign-roles
...
execute if score round AC_pktScores matches 1 run function ac:games/pkt/roundtype-1
execute if score round AC_pktScores matches 3 run function ac:games/pkt/roundtype-1
execute if score round AC_pktScores matches 5 run function ac:games/pkt/roundtype-1

execute if score round AC_pktScores matches 2 run function ac:games/pkt/roundtype-2
execute if score round AC_pktScores matches 4 run function ac:games/pkt/roundtype-2
execute if score round AC_pktScores matches 6 run function ac:games/pkt/roundtype-2
