execute if score box AC_running matches 1 run execute if score box AC_time matches 1880 run function ac:games/box/tp-to-map
execute if score box AC_running matches 1 run execute if score box AC_time matches 1880 run function ac:games/box/class-items
...
execute if score box AC_running matches 1 run execute if score box AC_time matches 1420..1880 run function ac:games/box/class-backend
...
execute if score box AC_running matches 1 run execute if score box AC_time matches 1415 run function ac:games/box/autoassign-class
execute if score box AC_running matches 1 run execute if score box AC_time matches 1415 run gamemode spectator @a
execute if score box AC_running matches 1 run execute if score box AC_time matches 1400 run function ac:games/box/round-advance
execute if score box AC_running matches 1 run execute if score box AC_time matches 1399 run execute if score round AC_boxCheck matches 1..6 run function ac:games/box/spawn-items
...
execute if score box AC_running matches 1 run execute if score box AC_time matches 1200 run function ac:games/box/round-start

execute if score box AC_running matches 1 run execute if score box1 AC_functions matches 1 if score box AC_time matches 1..1200 run function ac:games/box/round-backend
...
execute if score box AC_running matches 1 run execute if score box AC_time matches 0 run function ac:games/box/round-end
