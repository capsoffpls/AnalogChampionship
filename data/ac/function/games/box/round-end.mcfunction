...
execute unless score win-red AC_boxCheck matches 1.. unless score win-yellow AC_boxCheck matches 1.. unless score win-green AC_boxCheck matches 1.. unless score win-blue AC_boxCheck matches 1.. run function ac:games/box/check-for-draw
