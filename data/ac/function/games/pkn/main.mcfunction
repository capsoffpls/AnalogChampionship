execute if score pkn AC_running matches 1 if score round AC_pknScores matches 0..4 if score pkn AC_time matches 1260 run function ac:games/pkn/round-advance
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 5..6 if score pkn AC_time matches 1860 run function ac:games/pkn/round-advance
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 7 if score pkn AC_time matches 3660 run function ac:games/pkn/round-advance
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 1 if score pkn AC_time matches 1260 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Gra rozpocznie się za 3 sekundy...","color":"green","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 1 if score pkn AC_time matches 1240 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Gra rozpocznie się za 2 sekundy...","color":"green","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 1 if score pkn AC_time matches 1220 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Gra rozpocznie się za 1 sekundę...","color":"green","bold":false}]
...
execute if score pkn AC_running matches 1 as @a[gamemode=adventure,tag=InGame] run function ac:games/pkn/pattern-credit

execute if score pkn AC_running matches 1 if score pkn2 AC_functions matches 1 run function ac:games/pkn/finish-check
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 2..5 if score pkn AC_time matches 1260 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda rozpocznie się za 3 sekundy...","color":"yellow","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 2..5 if score pkn AC_time matches 1240 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda rozpocznie się za 2 sekundy...","color":"yellow","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 2..5 if score pkn AC_time matches 1220 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda rozpocznie się za 1 sekundę...","color":"yellow","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 6..7 if score pkn AC_time matches 1860 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda rozpocznie się za 3 sekundy...","color":"yellow","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 6..7 if score pkn AC_time matches 1840 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda rozpocznie się za 2 sekundy...","color":"yellow","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 6..7 if score pkn AC_time matches 1820 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda rozpocznie się za 1 sekundę...","color":"yellow","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 8 if score pkn AC_time matches 3660 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda finałowa rozpocznie się za 3 sekundy...","color":"red","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 8 if score pkn AC_time matches 3640 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda finałowa rozpocznie się za 2 sekundy...","color":"red","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 8 if score pkn AC_time matches 3620 if score lang AC_lang matches 0 run tellraw @a [{"text":"[PKN] ","bold":true,"color":"dark_green"},{"text":"Runda finałowa rozpocznie się za 1 sekundę...","color":"red","bold":false}]
...
execute if score pkn AC_running matches 1 if score round AC_pknScores matches 8 if score pkn AC_time matches 1..3600 run function ac:games/pkn/music
...
execute if score pkn AC_running matches 1 run function ac:games/pkn/display

execute if score pkn AC_running matches 1 run effect give @a invisibility 1 1 true

execute if score pkn AC_running matches 1 if score pkn1 AC_functions matches 1 if score InGame AC_playercount matches 1 run function ac:games/pkn/end
execute if score pkn AC_running matches 1 if score pkn1 AC_functions matches 1 if score pkn AC_time matches 0 if score round AC_pknScores matches 8 run function ac:games/pkn/end

execute if score pkn AC_running matches 1 as @a[tag=InGame] at @s[gamemode=adventure] if score @s AC_CurrentY matches ..40 run function ac:games/pkn/back-to-checkpoint
execute if score pkn AC_running matches 1 if score pkn1 AC_functions matches 1 run function ac:games/pkn/checkpoints
...
execute if score pkn AC_running matches 1 if score pkn1 AC_functions matches 1 as @a[tag=InGame,gamemode=adventure,scores={AC_pknHealth=..0},tag=!pknEliminated] unless score @s AC_LeftGame matches 1.. if entity @s run function ac:games/pkn/eliminate
