execute if score lbr AC_running matches 1 run execute if score lbr AC_time matches 1940 run function ac:games/lbr/prepare
...
execute if score lbr AC_running matches 1 if score lbr1 AC_functions matches 1 run execute as @a[x=-1004,y=51,z=496,dy=3,dx=8,dz=8] if entity @s[gamemode=adventure,tag=!lbrDead,tag=!lbrFinished] run function ac:games/lbr/finished

execute if score lbr AC_running matches 1 if score lbr1 AC_functions matches 1 run execute as @a[tag=InGame] if entity @s[scores={AC_deathmessage=1..}] run function ac:games/lbr/death
