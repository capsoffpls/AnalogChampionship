...
execute if score @s AC_ovkRespawnTime matches 101 run function ac:games/ovk/respawn-point
...
execute if score @s AC_ovkRespawnTime matches 99 run function ac:games/ovk/give-items
