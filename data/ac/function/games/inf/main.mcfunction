...
execute if score inf AC_running matches 1 if score inf3 AC_functions matches 1 run execute if score infected AC_infCount matches 5.. run function ac:games/inf/give-knockback
...
execute if score inf AC_running matches 1 if score inf4 AC_functions matches 1 run function ac:games/inf/elevator
execute if score inf AC_running matches 1 if score inf4 AC_functions matches 1 run execute if score jedzie AC_infCount matches 1 run function ac:games/inf/elevator-drive
