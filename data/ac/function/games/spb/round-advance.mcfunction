...
execute if score round AC_spbCheck matches 1 run function ac:games/spb/rng/pattern {"runda":"1"}
execute if score round AC_spbCheck matches 2 run function ac:games/spb/rng/pattern {"runda":"2"}
execute if score round AC_spbCheck matches 3 run function ac:games/spb/rng/pattern {"runda":"3"}
execute if score round AC_spbCheck matches 4 run function ac:games/spb/rng/pattern {"runda":"4"}
execute if score round AC_spbCheck matches 5 run function ac:games/spb/rng/pattern {"runda":"5"}
execute if score round AC_spbCheck matches 6 run function ac:games/spb/rng/pattern {"runda":"6"}
execute if score round AC_spbCheck matches 7 run function ac:games/spb/rng/pattern {"runda":"7"}
execute if score round AC_spbCheck matches 8 run function ac:games/spb/rng/pattern {"runda":"8"}
execute if score round AC_spbCheck matches 9 run function ac:games/spb/rng/pattern {"runda":"9"}
execute if score round AC_spbCheck matches 10 run function ac:games/spb/rng/pattern {"runda":"10"}
execute if score round AC_spbCheck matches 11.. run scoreboard players set spb AC_time -1000

execute as @a[tag=InGame,gamemode=adventure] run function ac:games/spb/give-building-blocks
