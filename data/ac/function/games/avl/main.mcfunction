...
execute if score avl AC_running matches 1 if score avl AC_time matches 59 run function ac:games/avl/roundstart
execute if score avl AC_running matches 1 if score avl AC_time matches 1 run fill -987 99 1014 -1014 99 987 moving_piston
execute if score avl AC_running matches 1 if score avl AC_time matches -10..1 run function ac:games/avl/snowball-spawn
