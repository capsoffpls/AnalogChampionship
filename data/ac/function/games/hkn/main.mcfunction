execute if score hkn AC_running matches 1 if score hkn AC_time matches 12200 run function ac:games/hkn/prepare

execute if score hkn AC_running matches 1 run function ac:games/hkn/ride
...
execute if score hkn AC_running matches 1 if score hkn1 AC_functions matches 1 run function ac:games/hkn/bonus
execute if score hkn AC_running matches 1 if score hkn1 AC_functions matches 1 run function ac:games/hkn/velocity-decay

execute if score hkn AC_running matches 1 if score hkn1 AC_functions matches 1 run function ac:games/hkn/calc-diff
...
execute if score hkn AC_running matches 1 if score hkn1 AC_functions matches 1 run function ac:games/hkn/checkpoints
...
execute if score hkn AC_running matches 1 if score hkn1 AC_functions matches 1 run function ac:games/hkn/wrong-way-check
...
execute if score hkn AC_running matches 1 if score hkn1 AC_functions matches 1 run execute as @a[advancements={ac:hkn_hitdetect=true}] if entity @s[tag=hknEliminated] if score @s AC_hknAttackTimer matches 0 run function ac:games/hkn/hit-reward
