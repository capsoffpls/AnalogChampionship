...
execute if score phc AC_running matches 1 if score phc1 AC_functions matches 1 as @a[tag=InGame,gamemode=adventure] run function ac:games/phc/spawn
...
execute if score phc AC_running matches 1 if score phc1 AC_functions matches 1 run execute as @a[gamemode=adventure,scores={AC_phcDeath=1..}] if entity @s run function ac:games/phc/death

execute if score phc AC_running matches 1 if score phc AC_time matches ..0 run execute if score InGame AC_playercount matches 1 run function ac:games/phc/end-winner
execute if score phc AC_running matches 1 if score phc AC_time matches ..0 run execute if score InGame AC_playercount matches 0 run function ac:games/phc/end-nowinner
...
execute if score phc AC_running matches 1 if score phc AC_time matches 1000 run function ac:base/remove-spawn-tags
