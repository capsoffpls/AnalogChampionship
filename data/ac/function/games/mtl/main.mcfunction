execute if score mtl AC_running matches 1 if score mtl AC_time matches 1360 run function ac:games/mtl/prepare
execute if score mtl AC_running matches 1 if score mtl AC_time matches 0..1360 run function ac:games/mtl/ride
