execute if score spb AC_running matches 1 if score spb1 AC_functions matches 1 run execute if score islands AC_spbCheck matches 1 run function ac:spb/islands
...
execute if score spb AC_running matches 1 if score spb1 AC_functions matches 1 run execute if score spb AC_time matches 0..2400 run function ac:spb/gamemode
...
execute if score spb AC_running matches 1 if score spb3 AC_functions matches 1 run execute if score spb AC_time matches 2400 run function ac:spb/tp-to-islands

execute if score spb AC_running matches 1 if score spb3 AC_functions matches 1 run execute if score spb AC_time matches 1200 run function ac:spb/count-blocks
...
execute if score spb AC_running matches 1 if score spb3 AC_functions matches 1 run execute if score spb AC_time matches 600 run function ac:spb/count-blocks
...
execute if score spb AC_running matches 1 if score spb3 AC_functions matches 1 run execute if score spb AC_time matches -1 run function ac:spb/count-blocks
...
execute if score spb AC_running matches 1 if score spb3 AC_functions matches 1 run execute if score spb AC_time matches -100 run function ac:spb/detect-weakest
...
execute if score spb AC_running matches 1 if score spb3 AC_functions matches 1 run execute if score spb AC_time matches -120 run function ac:spb/percentage-bonus
execute if score spb AC_running matches 1 if score spb3 AC_functions matches 1 run execute if score spb AC_time matches -150 run function ac:spb/round-prepare
...
execute if score spb AC_running matches 1 as @a[tag=spawn1,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1500 64 -560 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn2,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1523 64 -555 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn3,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1542 64 -542 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn4,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1555 64 -523 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn5,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1560 64 -500 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn6,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1555 64 -477 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn7,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1542 64 -458 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn8,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1523 64 -445 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn9,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1500 64 -440 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn10,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1477 64 -445 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn11,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1458 64 -458 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn12,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1445 64 -477 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn13,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1440 64 -500 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn14,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1445 64 -523 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn15,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1458 64 -542 run function ac:spb/arrow-particle
execute if score spb AC_running matches 1 as @a[tag=spawn16,tag=!spbEliminated,gamemode=spectator] if entity @s positioned 1477 64 -555 run function ac:spb/arrow-particle
