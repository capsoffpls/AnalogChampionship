...
execute if score duel_1 AC_QueuedCount matches 1 if score lang AC_lang matches 0 run bossbar set ac_duel1 name [{interpret:true,storage:"ac:queue.duels.1",nbt:"mode_name",color:"yellow",bold:true},{"text":" - oczekiwanie na pojedynek","color":"gold","bold":false}]
...
execute if score duel_2 AC_QueuedCount matches 1 if score lang AC_lang matches 0 run bossbar set ac_duel2 name [{interpret:true,storage:"ac:queue.duels.2",nbt:"mode_name",color:"yellow",bold:true},{"text":" - oczekiwanie na pojedynek","color":"gold","bold":false}]
...
execute if score duel_3 AC_QueuedCount matches 1 if score lang AC_lang matches 0 run bossbar set ac_duel3 name [{interpret:true,storage:"ac:queue.duels.3",nbt:"mode_name",color:"yellow",bold:true},{"text":" - oczekiwanie na pojedynek","color":"gold","bold":false}]
