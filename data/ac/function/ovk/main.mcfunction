execute if score ovk AC_running matches 1 if score ovk AC_time matches 12000 run function ac:ovk/start
...
execute if score ovk AC_running matches 1 if score ovk1 AC_functions matches 1 run execute as @a[scores={AC_ovkKillCheck=1..},tag=InGame,gamemode=adventure] if entity @s run function ac:ovk/compare-players
...
execute if score ovk AC_running matches 1 if score ovk1 AC_functions matches 1 run execute as @a[scores={AC_ovkKillCheck=1..}] if entity @s run function ac:ovk/give-items
...
execute if score ovk AC_running matches 1 if score ovk1 AC_functions matches 1 run execute as @a[tag=ovkCooldown] run function ac:ovk/death-cooldown
