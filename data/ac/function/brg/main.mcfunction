execute if score brg AC_running matches 1 if score brg AC_time matches 6100 run function ac:brg/tp-to-boxes
...
execute if score brg AC_running matches 1 if score brg AC_time matches 6000 run execute as @a run function ac:brg/give-items
...
execute if score brg AC_running matches 1 if score brg1 AC_functions matches 1 run execute as @a unless entity @s[nbt={Inventory:[{id:"minecraft:arrow"}]}] run function ac:brg/bow-cooldown
execute if score brg AC_running matches 1 if score brg1 AC_functions matches 1 run kill @e[type=arrow,nbt={inGround:1b}]

execute if score brg AC_running matches 1 if score brg1 AC_functions matches 1 run execute as @a if score @s AC_deathmessage matches 1.. run function ac:brg/death

execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run function ac:brg/goal-particles
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run execute as @a[x=1498,y=98,z=-44,dx=4,dz=4,gamemode=adventure,tag=InGame] if entity @s run function ac:brg/score-red
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run execute as @a[x=1540,y=98,z=-2,dx=4,dz=4,gamemode=adventure,tag=InGame] if entity @s run function ac:brg/score-yellow
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run execute as @a[x=1498,y=98,z=40,dx=4,dz=4,gamemode=adventure,tag=InGame] if entity @s run function ac:brg/score-green
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 run execute as @a[x=1456,y=98,z=-2,dx=4,dz=4,gamemode=adventure,tag=InGame] if entity @s run function ac:brg/score-blue
...
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 if score red AC_brgScore matches 0 if score red AC_brgPlayersLeft matches 0 run function ac:brg/team-outlived {team:"red"}
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 if score yellow AC_brgScore matches 0 if score yellow AC_brgPlayersLeft matches 0 run function ac:brg/team-outlived {team:"yellow"}
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 if score green AC_brgScore matches 0 if score green AC_brgPlayersLeft matches 0 run function ac:brg/team-outlived {team:"green"}
execute if score brg AC_running matches 1 if score brg2 AC_functions matches 1 if score blue AC_brgScore matches 0 if score blue AC_brgPlayersLeft matches 0 run function ac:brg/team-outlived {team:"blue"}

execute if score brg AC_running matches 1 if score brg AC_time matches -2399..5900 run execute if score yellow AC_brgPlayersLeft matches 0 if score blue AC_brgPlayersLeft matches 0 if score green AC_brgPlayersLeft matches 0 run function ac:brg/end-red
execute if score brg AC_running matches 1 if score brg AC_time matches -2399..5900 run execute if score red AC_brgPlayersLeft matches 0 if score blue AC_brgPlayersLeft matches 0 if score green AC_brgPlayersLeft matches 0 run function ac:brg/end-yellow
execute if score brg AC_running matches 1 if score brg AC_time matches -2399..5900 run execute if score red AC_brgPlayersLeft matches 0 if score blue AC_brgPlayersLeft matches 0 if score yellow AC_brgPlayersLeft matches 0 run function ac:brg/end-green
execute if score brg AC_running matches 1 if score brg AC_time matches -2399..5900 run execute if score red AC_brgPlayersLeft matches 0 if score yellow AC_brgPlayersLeft matches 0 if score green AC_brgPlayersLeft matches 0 run function ac:brg/end-blue
