...
scoreboard players operation 40 AC_gamemode = 40 AC_gamemodeStorage
scoreboard players operation 41 AC_gamemode = 41 AC_gamemodeStorage
...
scoreboard players operation 46 AC_gamemode = 46 AC_gamemodeStorage
