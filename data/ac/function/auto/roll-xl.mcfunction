...
execute unless score 37 AC_gamemode matches 0 if score roll-xl AC_autoControl matches 6 run scoreboard players add roll-xl AC_autoControl 1
execute unless score 46 AC_gamemode matches 0 if score roll-xl AC_autoControl matches 7 run scoreboard players set roll-xl AC_autoControl 1
...
execute unless score 25 AC_gamemode matches 0 if score roll-xl AC_autoControl matches 5 run scoreboard players add roll-xl AC_autoControl 1
execute unless score 37 AC_gamemode matches 0 if score roll-xl AC_autoControl matches 6 run scoreboard players add roll-xl AC_autoControl 1
$execute unless score 46 AC_gamemode matches 0 if score roll-xl AC_autoControl matches 7 run return run function ac:auto/roll-xl {type:$(type),game:$(game),choose:$(choose)}
...
$execute if score roll-xl AC_autoControl matches 7 run scoreboard players set $(type)vote$(game)-$(choose) AC_autoControl 46
...
$execute if score $(type)vote$(game)-$(choose) AC_autoControl matches 46 run scoreboard players set 46 AC_gamemode -1
