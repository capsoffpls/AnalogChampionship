...
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-1 AC_autoControl matches 46 run data modify storage ac:auto.vote option1 set value "Maze Games"
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-2 AC_autoControl matches 46 run data modify storage ac:auto.vote option2 set value "Maze Games"
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-3 AC_autoControl matches 46 run data modify storage ac:auto.vote option3 set value "Maze Games"
$execute if score game$(game) AC_autoControl matches -10 if score playervote$(game)-4 AC_autoControl matches 46 run data modify storage ac:auto.vote option4 set value "Maze Games"
...
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-1 AC_autoControl matches 46 run data modify storage ac:auto.vote option1 set value "Maze Games"
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-2 AC_autoControl matches 46 run data modify storage ac:auto.vote option2 set value "Maze Games"
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-3 AC_autoControl matches 46 run data modify storage ac:auto.vote option3 set value "Maze Games"
$execute if score game$(game) AC_autoControl matches -20 if score publicvote$(game)-4 AC_autoControl matches 46 run data modify storage ac:auto.vote option4 set value "Maze Games"
