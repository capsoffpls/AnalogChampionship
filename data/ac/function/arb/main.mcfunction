...
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 run function ac:arb/checkpoints
...
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 1..31 if score tick AC_arbArrow matches 19 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 11..24 if score tick AC_arbArrow matches 9 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 19..24 if score tick AC_arbArrow matches 4 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 19..24 if score tick AC_arbArrow matches 14 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 25..28 if score tick AC_arbArrow matches 15 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 25..28 if score tick AC_arbArrow matches 11 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 25..28 if score tick AC_arbArrow matches 7 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 25..31 if score tick AC_arbArrow matches 3 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 29..31 if score tick AC_arbArrow matches 6 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 29..31 if score tick AC_arbArrow matches 9 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 29..31 if score tick AC_arbArrow matches 13 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
execute if score arb AC_running matches 1 run execute if score arb1 AC_functions matches 1 if score shootspeed AC_arbRNG matches 29..31 if score tick AC_arbArrow matches 16 run execute as @a[tag=InGame,gamemode=adventure] at @s run function ac:arb/shoot
...
execute if score arb AC_running matches 1 run execute as @a[tag=InGame,gamemode=adventure] if entity @s[x=-2007,y=90,z=-854,dx=14,dy=4] run function ac:arb/reward
