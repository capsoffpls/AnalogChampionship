...
execute if score ctf AC_chosenMap matches 0 run spreadplayers 0 -1000 0 90 false @e[type=minecraft:area_effect_cloud,tag=border-center]
execute if score ctf AC_chosenMap matches 1 run spreadplayers 1000 -1000 0 90 false @e[type=minecraft:area_effect_cloud,tag=border-center]
