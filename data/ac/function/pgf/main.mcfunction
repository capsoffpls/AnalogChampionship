...
execute if score pgf AC_running matches 1 as @a[tag=InGame,gamemode=adventure] at @s if entity @s[y=53,dy=-15] run function ac:pgf/tp-back
...
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 1 if score second AC_misc matches 4 positioned -2021.1 64 521 run function ac:pgf/summon
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 1 if score second AC_misc matches 14 positioned -2021 64 521.1 run function ac:pgf/summon

execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 2 if score second AC_misc matches 4 positioned -2021.1 64 479 run function ac:pgf/summon
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 2 if score second AC_misc matches 14 positioned -2021 64 479.1 run function ac:pgf/summon

execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 3 if score second AC_misc matches 4 positioned -1979.1 64 479 run function ac:pgf/summon
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 3 if score second AC_misc matches 14 positioned -1979 64 479.1 run function ac:pgf/summon

execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 4 if score second AC_misc matches 4 positioned -1979.1 64 521 run function ac:pgf/summon
execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 if score #spawn AC_pgfCount matches 4 if score second AC_misc matches 14 positioned -1979 64 521.1 run function ac:pgf/summon

execute if score pgf AC_running matches 1 if score pgf1 AC_functions matches 1 run function ac:pgf/count-pigs

execute if score pgf AC_running matches 1 if score pgf AC_time matches 0 run function ac:pgf/pick-winner
