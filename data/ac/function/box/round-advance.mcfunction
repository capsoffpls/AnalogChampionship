...
execute if score round AC_boxCheck matches 1..6 run function ac:box/class-give
execute if score round AC_boxCheck matches 1..6 run function ac:box/tp-players
