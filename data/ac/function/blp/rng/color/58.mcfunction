clone 969 318 -531 1031 318 -469 969 50 -531
...
execute if score color AC_blpColorRNG matches 6 run scoreboard players set rng AC_blpColorRNG 8
execute if score color AC_blpColorRNG matches 7 run scoreboard players set rng AC_blpColorRNG 3
execute if score color AC_blpColorRNG matches 8 run scoreboard players set rng AC_blpColorRNG 14
execute if score color AC_blpColorRNG matches 9 run scoreboard players set rng AC_blpColorRNG 7
