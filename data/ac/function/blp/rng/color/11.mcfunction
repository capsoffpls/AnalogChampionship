clone 969 130 -531 1031 130 -469 969 50 -531
...
execute if score color AC_blpColorRNG matches 6 run scoreboard players set rng AC_blpColorRNG 14
execute if score color AC_blpColorRNG matches 7 run scoreboard players set rng AC_blpColorRNG 5
execute if score color AC_blpColorRNG matches 8 run scoreboard players set rng AC_blpColorRNG 15
execute if score color AC_blpColorRNG matches 9 run scoreboard players set rng AC_blpColorRNG 0
