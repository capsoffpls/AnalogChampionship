clone 969 170 -531 1031 170 -469 969 50 -531

execute store result score color AC_blpColorRNG run random value 0..8

execute if score color AC_blpColorRNG matches 0 run scoreboard players set rng AC_blpColorRNG 14
...
execute if score color AC_blpColorRNG matches 6 run scoreboard players set rng AC_blpColorRNG 10
