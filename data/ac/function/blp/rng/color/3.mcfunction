clone 969 98 -531 1031 98 -469 969 50 -531

execute store result score color AC_blpColorRNG run random value 0..13
...
execute if score color AC_blpColorRNG matches 9 run scoreboard players set rng AC_blpColorRNG 2
execute if score color AC_blpColorRNG matches 10 run scoreboard players set rng AC_blpColorRNG 10
execute if score color AC_blpColorRNG matches 11 run scoreboard players set rng AC_blpColorRNG 14
execute if score color AC_blpColorRNG matches 12 run scoreboard players set rng AC_blpColorRNG 15
execute if score color AC_blpColorRNG matches 13 run scoreboard players set rng AC_blpColorRNG 12