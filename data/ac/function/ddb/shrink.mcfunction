execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 1 run function ac:ddb/size/1
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 2 run function ac:ddb/size/2
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 3 run function ac:ddb/size/3
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 4 run function ac:ddb/size/4
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 5 run function ac:ddb/size/5
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 6 run function ac:ddb/size/6
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 7 run function ac:ddb/size/7
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 8 run function ac:ddb/size/8
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 9 run function ac:ddb/size/9
execute if score shrinktime AC_ddbSize matches 60 run execute if score size AC_ddbSize matches 10 run function ac:ddb/size/10
