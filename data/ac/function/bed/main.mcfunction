execute if score bed AC_running matches 1 run execute if score bed AC_time matches 36100 run function ac:bed/prepare
...
execute if score bed AC_running matches 1 run execute as @a[tag=InGame,gamemode=!spectator] if score @s AC_bedCurrentY matches 50.. run function ac:bed/update_currency

execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 1 run function ac:bed/shops
execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 6 run function ac:bed/shops
execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 11 run function ac:bed/shops
execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 16 run function ac:bed/shops

execute if score bed AC_running matches 1 if score bed1 AC_functions matches 1 run execute if score second AC_bedTimer matches 13 run function ac:bed/stock_items
...
execute if score bed AC_running matches 1 run execute if score bed2 AC_functions matches 1 run execute if score second AC_bedTimer matches 11 run execute as @a[tag=InGame,tag=!bedDead,tag=!drankInvis] run function ac:bed/give_armor
...
execute if score bed AC_running matches 1 run execute if score bed3 AC_functions matches 1 run function ac:bed/team_specific_functions
execute if score bed AC_running matches 1 run execute if score bed3 AC_functions matches 1 run execute as @a[tag=InGame] if score @s AC_bedUsedBridgeEgg matches 1.. run function ac:bed/bridge_egg
...
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute if score bed AC_chosenMap matches 0 unless block 1448 56 -952 red_bed as @a[tag=InGame,team=ac_bedRed] unless entity @s[tag=bedDestroyed] unless entity @s[tag=bedDead] run function ac:bed/bed_destroyed
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute if score bed AC_chosenMap matches 0 unless block 1452 56 -1052 yellow_bed as @a[tag=InGame,team=ac_bedYellow] unless entity @s[tag=bedDestroyed] unless entity @s[tag=bedDead] run function ac:bed/bed_destroyed
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute if score bed AC_chosenMap matches 0 unless block 1552 56 -1048 lime_bed as @a[tag=InGame,team=ac_bedGreen] unless entity @s[tag=bedDestroyed] unless entity @s[tag=bedDead] run function ac:bed/bed_destroyed
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute if score bed AC_chosenMap matches 0 unless block 1548 56 -948 blue_bed as @a[tag=InGame,team=ac_bedBlue] unless entity @s[tag=bedDestroyed] unless entity @s[tag=bedDead] run function ac:bed/bed_destroyed

execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute as @a[tag=InGame] if score @s AC_bedDeathCheck matches 1.. run function ac:bed/death
execute if score bed AC_running matches 1 run execute if score bed4 AC_functions matches 1 run execute as @a[tag=bedDeathCooldown] run function ac:bed/death_cooldown

execute if score bed AC_running matches 1 run execute if score bed5 AC_functions matches 1 run execute as @e[type=item_display,tag=bedBaseGenRed] run function ac:bed/base_gen_red
execute if score bed AC_running matches 1 run execute if score bed5 AC_functions matches 1 run execute as @e[type=item_display,tag=bedBaseGenYellow] run function ac:bed/base_gen_yellow
execute if score bed AC_running matches 1 run execute if score bed5 AC_functions matches 1 run execute as @e[type=item_display,tag=bedBaseGenGreen] run function ac:bed/base_gen_green
execute if score bed AC_running matches 1 run execute if score bed5 AC_functions matches 1 run execute as @e[type=item_display,tag=bedBaseGenBlue] run function ac:bed/base_gen_blue
...
execute if score bed AC_running matches 1 run execute if score bed6 AC_functions matches 1 run execute as @a[tag=!drankInvis] if entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] run function ac:bed/invis
...
execute if score bed AC_running matches 1 run execute if score bed6 AC_functions matches 1 run execute as @a[tag=drankInvis] unless entity @s[nbt={active_effects:[{id:"minecraft:invisibility"}]}] run function ac:bed/give_armor
...
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 1..35500 if score yellow AC_bedPlayersLeft matches 0 if score blue AC_bedPlayersLeft matches 0 if score green AC_bedPlayersLeft matches 0 run function ac:bed/end_red
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 1..35500 if score red AC_bedPlayersLeft matches 0 if score blue AC_bedPlayersLeft matches 0 if score green AC_bedPlayersLeft matches 0 run function ac:bed/end_yellow
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 1..35500 if score red AC_bedPlayersLeft matches 0 if score blue AC_bedPlayersLeft matches 0 if score yellow AC_bedPlayersLeft matches 0 run function ac:bed/end_green
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 1..35500 if score red AC_bedPlayersLeft matches 0 if score yellow AC_bedPlayersLeft matches 0 if score green AC_bedPlayersLeft matches 0 run function ac:bed/end_blue
execute if score bed AC_running matches 1 run execute if score bed AC_time matches 0 run function ac:bed/end_timeout
...
execute if score bed AC_running matches 1 run execute if score bed AC_time matches -1 run function ac:bed/reset_message_control
