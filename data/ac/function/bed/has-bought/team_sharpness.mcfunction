...
execute unless entity @s[tag=Sharp1] if score @s AC_bedDiamond matches 8.. run execute as @s[team=ac_bedRed] if entity @s run function ac:bed/shopping-items/team_sharpness
execute unless entity @s[tag=Sharp1] if score @s AC_bedDiamond matches 8.. run execute as @s[team=ac_bedYellow] if entity @s run function ac:bed/shopping-items/team_sharpness
execute unless entity @s[tag=Sharp1] if score @s AC_bedDiamond matches 8.. run execute as @s[team=ac_bedGreen] if entity @s run function ac:bed/shopping-items/team_sharpness
execute unless entity @s[tag=Sharp1] if score @s AC_bedDiamond matches 8.. run execute as @s[team=ac_bedBlue] if entity @s run function ac:bed/shopping-items/team_sharpness
