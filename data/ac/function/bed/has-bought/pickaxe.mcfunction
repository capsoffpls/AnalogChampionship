...
execute if score @s AC_bedPickaxe matches 3 if score @s AC_bedGold matches 6.. run function ac:bed/shopping-items/diamond_pickaxe
...
execute if score @s AC_bedPickaxe matches 2 if score @s AC_bedGold matches 3.. run function ac:bed/shopping-items/golden_pickaxe
...
execute if score @s AC_bedPickaxe matches 1 if score @s AC_bedIron matches 10.. run function ac:bed/shopping-items/iron_pickaxe
...
execute if score @s AC_bedPickaxe matches 0 if score @s AC_bedIron matches 10.. run function ac:bed/shopping-items/wooden_pickaxe
