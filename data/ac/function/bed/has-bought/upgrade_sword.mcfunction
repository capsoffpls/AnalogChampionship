...
execute if score @s AC_bedSword matches 3 if score @s AC_bedEmerald matches 3.. run function ac:bed/shopping-items/diamond_sword
...
execute if score @s AC_bedSword matches 2 if score @s AC_bedGold matches 7.. run function ac:bed/shopping-items/iron_sword
...
execute if score @s AC_bedSword matches 0..1 if score @s AC_bedIron matches 10.. run function ac:bed/shopping-items/stone_sword
