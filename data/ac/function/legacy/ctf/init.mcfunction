...
function ac:legacy/ctf/rng/map
execute if score ctf AC_chosenMap matches 0 run function ac:legacy/ctf/launch-map/0
execute if score ctf AC_chosenMap matches 1 run function ac:legacy/ctf/launch-map/1
