execute if score ctf AC_running matches 1 if score ctf AC_time matches 24036 run function ac:legacy/ctf/prepare
...
execute if score ctf AC_running matches 1 if score ctf AC_time matches 0 run function ac:legacy/ctf/deathmatch
...
execute if score ctf AC_running matches 1 if score ctf AC_time matches -4000 run function ac:legacy/ctf/end
...
execute if score ctf AC_running matches 1 run execute as @a[tag=InGame] if entity @s[tag=!ctfBuildLimit,advancements={ac:ctf_buildlimit=true}] run function ac:legacy/ctf/warn-buildlimit
...
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function ac:legacy/ctf/death-cooldown
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function ac:legacy/ctf/playerdies
execute if score ctf AC_running matches 1 if score ctf2 AC_functions matches 1 run function ac:legacy/ctf/spawnprot
...
execute if score ctf AC_running matches 1 if score ctf3 AC_functions matches 1 run function ac:legacy/ctf/own-flag-room
execute if score ctf AC_running matches 1 if score ctf3 AC_functions matches 1 run function ac:legacy/ctf/conquering
...
execute if score ctf AC_running matches 1 if score ctf3 AC_functions matches 1 run function ac:legacy/ctf/team-status