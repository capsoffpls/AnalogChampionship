...
execute if score totalGM AC_autoControl matches 8 if score game AC_autoControl matches 9.. run scoreboard players set game AC_autoControl 1
execute if score totalGM AC_autoControl matches 16 if score game AC_autoControl matches 16.. run scoreboard players set game AC_autoControl 1
