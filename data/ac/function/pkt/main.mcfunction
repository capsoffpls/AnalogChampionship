execute if score pkt AC_running matches 1 if score pkt AC_time matches 2000 run function ac:pkt/round-advance
...
execute if score pkt AC_running matches 1 if score pkt1 AC_functions matches 1 run function ac:pkt/eliminate

execute if score pkt AC_running matches 1 if score pkt1 AC_functions matches 1 run execute unless entity @a[tag=InGame,gamemode=adventure,tag=!pktHunter] run function ac:pkt/hunters-win

execute if score pkt AC_running matches 1 if score pkt1 AC_functions matches 1 run execute if score pkt AC_time matches 0 run function ac:pkt/runners-win
