...
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run function ac:dtr/traps
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run function ac:dtr/area-main
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run function ac:dtr/teleporters
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run function ac:dtr/checkpoints
...
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run execute as @a[team=ac_dtrRunner,scores={AC_killmessage=1..}] if entity @a[team=ac_dtrDeath,scores={AC_deathmessage=1..}] run function ac:dtr/death-inherit
execute if score dtr AC_running matches 1 if score dtr1 AC_functions matches 1 run execute as @a[team=ac_dtrRunner,scores={AC_deathmessage=1..}] if entity @s run function ac:dtr/death-credit
