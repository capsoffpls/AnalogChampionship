...
execute if score tbk AC_running matches 1 if score tbk AC_time matches 12000 run function ac:tbk/items

execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 run function ac:tbk/fly
execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 run function ac:tbk/health
...
execute if score tbk AC_running matches 1 if score tbk1 AC_functions matches 1 run function ac:tbk/snowball/main
