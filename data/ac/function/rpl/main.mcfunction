execute if score rpl AC_running matches 1 if score rpl AC_time matches 1340 run function ac:rpl/roll
...
execute if score rpl AC_running matches 1 if score rpl1 AC_functions matches 1 run execute as @a[tag=InGame] if entity @s[advancements={ac:rpl.blockplacement=true}] run function ac:rpl/check
