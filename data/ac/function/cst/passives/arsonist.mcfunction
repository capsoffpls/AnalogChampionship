...
execute at @e[type=marker,tag=arsonistdeath] as @a[team=ac_cstDefend,distance=..5.5,tag=cstTank] run damage @s 16 generic_kill by @n[tag=this]
execute at @e[type=marker,tag=arsonistdeath] as @a[team=ac_cstDefend,distance=..5.5,tag=!cstTank] run damage @s 8 generic_kill by @n[tag=this]
