execute if score cst AC_running matches 1 if score cst AC_time matches 24060 run function ac:cst/prepare
...
execute if score cst AC_running matches 1 if score cst AC_time matches 24000 run function ac:cst/start
...
execute if score cst AC_running matches 1 run execute as @a[team=ac_cstAttack,x=-2055,y=51,z=1606,dx=111,dy=50,dz=-250] if entity @s[tag=!cstArsonist,tag=!cstRebel,tag=!cstScout,tag=!cstSniper,tag=!cstWarrior,tag=!cstAssassin,gamemode=adventure] run function ac:cst/attacker-no-kit
execute if score cst AC_running matches 1 run execute as @a[team=ac_cstDefend,x=-2010,y=70,z=1372,dx=24,dy=50,dz=24] if entity @s[tag=!cstWarrior,tag=!cstTank,tag=!cstAssassin,tag=!cstShooter,tag=!cstScout,tag=!cstSniper,gamemode=adventure] run function ac:cst/defender-no-kit
...
execute if score cst AC_running matches 1 run execute as @a[scores={AC_deathmessage=1..}] run function ac:cst/death
execute if score cst AC_running matches 1 run execute as @a[tag=cstCooldown] run function ac:cst/death-cooldown

execute if score cst AC_running matches 1 run execute as @e[tag=cstNexus] on attacker if entity @s[team=ac_cstAttack] run function ac:cst/attack-core
execute if score cst AC_running matches 1 run function ac:cst/base-healthbar
execute if score cst AC_running matches 1 run function ac:cst/kits-backend
...
execute if score cst AC_running matches 1 run function ac:cst/passives/tank

execute if score cst AC_running matches 1 if score cst AC_time matches 1..24000 unless entity @a[team=ac_cstAttack,tag=!cstCooldown] run function ac:cst/end-attackers-aced {condition:1}
execute if score cst AC_running matches 1 if score cst AC_time matches 1..24000 unless entity @a[team=ac_cstDefend,tag=!cstCooldown] run function ac:cst/end-defenders-aced {condition:2}
execute if score cst AC_running matches 1 if score cst AC_time matches 1..24000 if score baseHealth AC_cstScores matches ..0 run function ac:cst/end-core-destroyed {condition:3}
execute if score cst AC_running matches 1 if score cst AC_time matches 1 run function ac:cst/end-timeout {condition:4}
