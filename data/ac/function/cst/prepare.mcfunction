...
execute as @e[type=armor_stand,tag=cstWarrior] run function ac:cst/classes/warrior
execute as @e[type=armor_stand,tag=cstAssassin] run function ac:cst/classes/assassin
execute as @e[type=armor_stand,tag=cstScout] run function ac:cst/classes/scout
execute as @e[type=armor_stand,tag=cstSniper] run function ac:cst/classes/sniper
execute as @e[type=armor_stand,tag=cstTank] run function ac:cst/classes/tank
execute as @e[type=armor_stand,tag=cstShooter] run function ac:cst/classes/shooter
execute as @e[type=armor_stand,tag=cstRebel] run function ac:cst/classes/rebel
execute as @e[type=armor_stand,tag=cstArsonist] run function ac:cst/classes/arsonist