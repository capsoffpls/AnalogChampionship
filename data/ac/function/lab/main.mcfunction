...
execute if score lab AC_running matches 1 run execute if score lab AC_time matches 1800 run function ac:lab/start
...
execute if score lab AC_running matches 1 if score lab1 AC_functions matches 1 run execute as @a[tag=InGame,x=-1518,y=3,z=1982,dy=2,dx=36,dz=36,tag=!labFinished] run function ac:lab/finished
