...
execute if score mfl AC_running matches 1 if score mfl1 AC_functions matches 1 run execute as @e[x=51,y=51,z=983,dz=35,dx=1,gamemode=adventure] run function ac:mfl/reward
